// Generated from Pokémon GO masterfile — group "iapItemDisplay", split "category+hidden+show-discount-tag+show-strikethrough-price+sort-order+sprite-id+title+total-value", 18 entries.
