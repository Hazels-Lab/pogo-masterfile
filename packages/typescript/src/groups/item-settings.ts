...
export interface ItemSettingsData<TemplateID extends string> {
	templateId: TemplateID;
	itemSettings: {
		category: ItemSettingsCategory;
		descriptionOverride?: ItemSettingsDescriptionOverride;
		dropTrainerLevel?: ItemSettingsDropTrainerLevel;
		eggIncubator?: {
			distanceMultiplier: ItemSettingsEggIncubatorDistanceMultiplier;
		...
		eventPassPoint?: {
			eventPassId: ItemSettingsEventPassPointEventPassID;
		};
		food?: {
			berryMultiplier?: ItemSettingsFoodBerryMultiplier;
			growthPercent?: 0.1;
			itemEffect?: Array<ItemSettingsFoodItemEffect>;
			itemEffectPercent?: Array<ItemSettingsFoodItemEffectPercent>;
			mapDurationMs?: ItemSettingsFoodMapDurationMs;
			numBuddyAffectionPoints?: ItemSettingsFoodNumBuddyAffectionPoints;
			numBuddyHungerPoints?: ItemSettingsFoodNumBuddyHungerPoints;
			remoteBerryMultiplier?: ItemSettingsFoodRemoteBerryMultiplier;
			timeFullDurationMs?: ItemSettingsFoodTimeFullDurationMs;
		};
		globalEventTicket?: {
			backgroundImageUrl?: ItemSettingsGlobalEventTicketBackgroundImageUrl;
			clientEventEndTimeUtcMs: ItemSettingsGlobalEventTicketClientEventEndTimeUtcMs;
			clientEventStartTimeUtcMs: ItemSettingsGlobalEventTicketClientEventStartTimeUtcMs;
			detailsLinkKey?: ItemSettingsGlobalEventTicketDetailsLinkKey;
			displayV2Enabled?: true;
			eventBadge?: "BADGE_GO_TOUR_2026_GLOBAL";
			eventBannerUrl?: ItemSettingsGlobalEventTicketEventBannerUrl;
			eventDatetimeRangeKey?: ItemSettingsGlobalEventTicketEventDatetimeRangeKey;
			eventEndTime: ItemSettingsGlobalEventTicketEventEndTime;
			eventStartTime: ItemSettingsGlobalEventTicketEventStartTime;
			giftable?: true;
			giftItem?: ItemSettingsGlobalEventTicketGiftItem;
			...
			iconRewards?: Array<
				{
					...
					exp?: ItemSettingsGlobalEventTicketIconRewardsExp;
					item?: {
						amount?: ItemSettingsGlobalEventTicketIconRewardsItemAmount;
						item: ItemSettingsGlobalEventTicketIconRewardsItemItem;
					};
					...
					pokemonEncounter?: {
						pokemonDisplay?: {
							form: ItemSettingsGlobalEventTicketIconRewardsPokemonEncounterPokemonDisplayForm;
							shiny?: true;
						};
						pokemonId: ItemSettingsGlobalEventTicketIconRewardsPokemonEncounterPokemonID;
					};
					stardust?: ItemSettingsGlobalEventTicketIconRewardsStardust;
					"type": ItemSettingsGlobalEventTicketIconRewardsType;
				}
			>;
			itemBagDescriptionKey: ItemSettingsGlobalEventTicketItemBagDescriptionKey;
			textRewardsKey?: ItemSettingsGlobalEventTicketTextRewardsKey;
			ticketItem?: ItemSettingsGlobalEventTicketTicketItem;
		...
		incense?: {
			incenseLifetimeSeconds: ItemSettingsIncenseIncenseLifetimeSeconds;
			spawnTableProbability?: ItemSettingsIncenseSpawnTableProbability;
		};
		incidentTicket?: {
			ignoreFullInventory?: true;
			upgradedItem?: ItemSettingsIncidentTicketUpgradedItem;
			upgradeRequirementCount?: ItemSettingsIncidentTicketUpgradeRequirementCount;
		};
		inventoryUpgrade?: {
			additionalStorage: 50;
			upgradeType: ItemSettingsInventoryUpgradeUpgradeType;
		};
		itemCap?: ItemSettingsItemCap;
		itemId: TemplateID;
		itemType: ItemSettingsItemType;
		nameOverride?: ItemSettingsNameOverride;
		potion?: {
			staAmount?: ItemSettingsPotionStaAmount;
			staPercent?: 1;
		};
		replenishMp?: {
			mpAmount: 800;
		...
		revive?: {
			staPercent: ItemSettingsReviveStaPercent;
		};
		stardustBoost?: {
		...
		statIncrease?: {
			statsToIncreaseLimit: ItemSettingsStatIncreaseStatsToIncreaseLimit;
		};
		timePeriodCounters?: {
			playerActivity: {
				limit: ItemSettingsTimePeriodCountersPlayerActivityLimit;
			};
		};
		xpBoost?: {
			boostDurationMs: 1800000;
