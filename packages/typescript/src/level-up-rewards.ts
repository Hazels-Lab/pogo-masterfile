// Generated from Pokémon GO masterfile — group "levelUpRewards", 97 entries.
...
export type LevelUpRewardsAwardsLevel10 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_10",
		{
			...
			items: ["ITEM_POKE_BALL", "ITEM_RAZZ_BERRY", "ITEM_POTION", "ITEM_REVIVE", "ITEM_LUCKY_EGG", "ITEM_INCUBATOR_BASIC", "ITEM_ITEM_STORAGE_UPGRADE_EARNED"];
			itemsCount: [20, 3, 10, 10, 1, 1, 25];
			level: 10;
		}
	>
>;
export type LevelUpRewardsAwardsLevel11 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_11",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel12 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_12",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel13 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_13",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel14 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_14",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel15 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_15",
		{
			clientOverrideDisplayOrder: true;
			featuresUnlocked: ["FEATURE_EGG_SPECIAL"];
			items: ["ITEM_GREAT_BALL", "ITEM_RAZZ_BERRY", "ITEM_POTION", "ITEM_REVIVE", "ITEM_STAR_PIECE", "ITEM_INCUBATOR_BASIC", "ITEM_TROY_DISK"];
			itemsCount: [15, 3, 10, 5, 1, 1, 1];
			level: 15;
		}
	>
>;
export type LevelUpRewardsAwardsLevel16 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_16",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel17 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_17",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel18 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_18",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel19 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_19",
		{
			clientOverrideDisplayOrder: true;
...
export type LevelUpRewardsAwardsLevel2 = S<
	...
	>
>;
export type LevelUpRewardsAwardsLevel20 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_20",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel21 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_21",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel22 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_22",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel23 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_23",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel24 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_24",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel25 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_25",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel26 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_26",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel27 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_27",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel28 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_28",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel29 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_29",
		{
			clientOverrideDisplayOrder: true;
...
export type LevelUpRewardsAwardsLevel3 = S<
	...
	>
>;
export type LevelUpRewardsAwardsLevel30 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_30",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel31 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_31",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel32 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_32",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel33 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_33",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel34 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_34",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel35 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_35",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel36 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_36",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel37 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_37",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel38 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_38",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel39 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_39",
		{
			clientOverrideDisplayOrder: true;
...
export type LevelUpRewardsAwardsLevel40 = S<
	...
	>
>;
export type LevelUpRewardsAwardsLevel41 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_41",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel42 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_42",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel43 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_43",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel44 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_44",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel45 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_45",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel46 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_46",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel47 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_47",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel48 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_48",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel49 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_49",
		{
			clientOverrideDisplayOrder: true;
...
export type LevelUpRewardsAwardsLevel5 = S<
	...
	>
>;
export type LevelUpRewardsAwardsLevel50 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_50",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel51 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_51",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel52 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_52",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel53 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_53",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel54 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_54",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel55 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_55",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel56 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_56",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel57 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_57",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel58 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_58",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel59 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_59",
		{
			clientOverrideDisplayOrder: true;
...
export type LevelUpRewardsAwardsLevel60 = S<
	...
	>
>;
export type LevelUpRewardsAwardsLevel61 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_61",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel62 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_62",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel63 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_63",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel64 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_64",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel65 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_65",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel66 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_66",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel67 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_67",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel68 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_68",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel69 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_69",
		{
			clientOverrideDisplayOrder: true;
...
export type LevelUpRewardsAwardsLevel7 = S<
	...
	>
>;
export type LevelUpRewardsAwardsLevel70 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_70",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel71 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_71",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel72 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_72",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel73 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_73",
		{
			clientOverrideDisplayOrder: true;
			items: ["ITEM_ULTRA_BALL", "ITEM_PINAP_BERRY", "ITEM_MAX_POTION", "ITEM_PAID_RAID_TICKET", "ITEM_XL_RARE_CANDY", "ITEM_GIFTBOX_STORAGE_UPGRADE_EARNED"];
	...
	>
>;
export type LevelUpRewardsAwardsLevel74 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_74",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel75 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_75",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel76 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_76",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel77 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_77",
		{
			clientOverrideDisplayOrder: true;
	...
	>
>;
export type LevelUpRewardsAwardsLevel78 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_78",
		{
			clientOverrideDisplayOrder: true;
			items: ["ITEM_ULTRA_BALL", "ITEM_RAZZ_BERRY", "ITEM_MAX_POTION", "ITEM_PAID_RAID_TICKET", "ITEM_XL_RARE_CANDY", "ITEM_POKEMON_STORAGE_UPGRADE_EARNED"];
			itemsCount: [30, 25, 20, 1, 1, 75];
			level: 78;
		}
	>
>;
export type LevelUpRewardsAwardsLevel79 = S<
	LevelUpRewards<
		"AWARDS_LEVEL_79",
		{
			clientOverrideDisplayOrder: true;
...
export type LevelUpRewardsAwardsLevel9 = S<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel10 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel20 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel25 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel30 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel35 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel40 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel43 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel45 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel47 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel50 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel53 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel55 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel57 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel60 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel63 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel65 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel67 = S<
	LevelUpRewards<
	...
	>
>;
export type LevelUpRewardsBackfillAwardsLevel70 = S<
	LevelUpRewards<
