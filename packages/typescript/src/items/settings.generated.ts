...
export interface Fusion_resource_black_kyuremdataitemsettings {
  category: string;
...
export interface Fusion_resource_black_kyuremdata {
  itemSettings: Fusion_resource_black_kyuremdataitemsettings;
  templateId: string;
}
export interface Fusion_resource_black_kyuremEntry {
  templateId: "FUSION_RESOURCE_BLACK_KYUREM";
  data: Fusion_resource_black_kyuremdata;
}
export interface Fusion_resource_dawnwings_necrozmaEntry {
  templateId: "FUSION_RESOURCE_DAWNWINGS_NECROZMA";
  data: Fusion_resource_black_kyuremdata;
}
export interface Fusion_resource_duskmane_necrozmaEntry {
  templateId: "FUSION_RESOURCE_DUSKMANE_NECROZMA";
  data: Fusion_resource_black_kyuremdata;
}
export interface Fusion_resource_white_kyuremEntry {
...
export interface Item_battle_pass_ticketdataitemsettings {
  category: string;
  globalEventTicket: Item_battle_pass_ticketdataitemsettingsglobaleventticket;
  itemId: string;
  itemType: string;
}
export interface Item_battle_pass_ticketdata {
  itemSettings: Item_battle_pass_ticketdataitemsettings;
  templateId: string;
}
export interface Item_battle_pass_ticketEntry {
...
export interface Item_beast_balldata {
  itemSettings: Item_beast_balldataitemsettings;
  templateId: string;
}
...
export interface Item_bluk_berrydataitemsettings {
  category: string;
  dropTrainerLevel: number;
  food: Item_bluk_berrydataitemsettingsfood;
  itemId: string;
  itemType: string;
}
export interface Item_bluk_berrydata {
  itemSettings: Item_bluk_berrydataitemsettings;
  templateId: string;
}
export interface Item_bluk_berryEntry {
...
export interface Item_enhanced_currency_holderdata {
  itemSettings: Item_enhanced_currency_holderdataitemsettings;
  templateId: string;
}
export interface Item_enhanced_currency_holderEntry {
  templateId: "ITEM_ENHANCED_CURRENCY_HOLDER";
  data: Item_enhanced_currency_holderdata;
}
export interface Item_event_pass_point_go_fest_01dataitemsettingseventpasspoint {
  eventPassId: string;
}
export interface Item_event_pass_point_go_fest_01dataitemsettings {
  category: string;
...
export interface Item_event_pass_point_go_fest_01data {
  itemSettings: Item_event_pass_point_go_fest_01dataitemsettings;
  templateId: string;
}
export interface Item_event_pass_point_go_fest_01Entry {
...
export interface Item_event_pass_point_go_fest_02dataitemsettingstimeperiodcounters {
  playerActivity: Item_event_pass_point_go_fest_02dataitemsettingstimeperiodcountersplayeractivity;
}
export interface Item_event_pass_point_go_fest_02dataitemsettings {
  category: string;
  eventPassPoint: Item_event_pass_point_go_fest_01dataitemsettingseventpasspoint;
  hideItemInInventory: boolean;
  ignoreInventorySpace: boolean;
  ...
  itemId: string;
  itemType: string;
  timePeriodCounters: Item_event_pass_point_go_fest_02dataitemsettingstimeperiodcounters;
}
export interface Item_event_pass_point_go_fest_02data {
  itemSettings: Item_event_pass_point_go_fest_02dataitemsettings;
  templateId: string;
}
export interface Item_event_pass_point_go_fest_02Entry {
  templateId: "ITEM_EVENT_PASS_POINT_GO_FEST_02";
...
export interface Item_event_pass_point_live_ops_01Entry {
  templateId: "ITEM_EVENT_PASS_POINT_LIVE_OPS_01";
  data: Item_event_pass_point_go_fest_02data;
}
export interface Item_event_pass_point_live_ops_02Entry {
  templateId: "ITEM_EVENT_PASS_POINT_LIVE_OPS_02";
  data: Item_event_pass_point_go_fest_02data;
}
export interface Item_event_pass_point_live_ops_03Entry {
  templateId: "ITEM_EVENT_PASS_POINT_LIVE_OPS_03";
  data: Item_event_pass_point_go_fest_02data;
}
export interface Item_event_pass_point_live_ops_04Entry {
  templateId: "ITEM_EVENT_PASS_POINT_LIVE_OPS_04";
  data: Item_event_pass_point_go_fest_02data;
}
export interface Item_event_pass_point_live_ops_05Entry {
  templateId: "ITEM_EVENT_PASS_POINT_LIVE_OPS_05";
  data: Item_event_pass_point_go_fest_02data;
}
export interface Item_event_pass_point_live_ops_06Entry {
...
export interface Item_event_pass_point_live_ops_07data {
  itemSettings: Item_event_pass_point_live_ops_07dataitemsettings;
  templateId: string;
}
export interface Item_event_pass_point_live_ops_07Entry {
...
export interface Item_event_pass_point_monthly_01data {
  itemSettings: Item_event_pass_point_monthly_01dataitemsettings;
  templateId: string;
}
...
export interface Item_event_ticket_02dataitemsettingsglobaleventticket {
  ...
  giftable: boolean;
  giftItem: string;
  iconRewards: (Item_event_ticket_02dataitemsettingsglobaleventticketiconrewardsitem)[];
  itemBagDescriptionKey: string;
  textRewardsKey: string;
}
export interface Item_event_ticket_02dataitemsettings {
  category: string;
  descriptionOverride: string;
  globalEventTicket: Item_event_ticket_02dataitemsettingsglobaleventticket;
  itemId: string;
  itemType: string;
  nameOverride: string;
}
export interface Item_event_ticket_02data {
  itemSettings: Item_event_ticket_02dataitemsettings;
  templateId: string;
}
export interface Item_event_ticket_02Entry {
  templateId: "ITEM_EVENT_TICKET_02";
  data: Item_event_ticket_02data;
}
export interface Item_event_ticket_02_to_giftdataitemsettingsglobaleventticket {
  clientEventEndTimeUtcMs: string;
  clientEventStartTimeUtcMs: string;
  eventBannerUrl: string;
  eventEndTime: string;
...
export interface Item_event_ticket_02_to_giftdataitemsettings {
  category: string;
  descriptionOverride: string;
  globalEventTicket: Item_event_ticket_02_to_giftdataitemsettingsglobaleventticket;
  ignoreInventorySpace: boolean;
  itemId: string;
  itemType: string;
  nameOverride: string;
}
export interface Item_event_ticket_02_to_giftdata {
  itemSettings: Item_event_ticket_02_to_giftdataitemsettings;
  templateId: string;
}
export interface Item_event_ticket_02_to_giftEntry {
...
export interface Item_event_ticket_03dataitemsettingsglobaleventticketiconrewardsitempokemonencounterpokemondisplay {
  form: string;
}
export interface Item_event_ticket_03dataitemsettingsglobaleventticketiconrewardsitempokemonencounter {
  pokemonDisplay: Item_event_ticket_03dataitemsettingsglobaleventticketiconrewardsitempokemonencounterpokemondisplay;
  pokemonId: string;
}
export interface Item_event_ticket_03dataitemsettingsglobaleventticketiconrewardsitem {
...
export interface Item_event_ticket_03dataitemsettingsglobaleventticket {
  backgroundImageUrl: string;
  clientEventEndTimeUtcMs: string;
  clientEventStartTimeUtcMs: string;
  detailsLinkKey: string;
  ...
  giftable: boolean;
  giftItem: string;
  iconRewards: (Item_event_ticket_03dataitemsettingsglobaleventticketiconrewardsitem)[];
  itemBagDescriptionKey: string;
  textRewardsKey: string;
}
export interface Item_event_ticket_03dataitemsettings {
  category: string;
  descriptionOverride: string;
  globalEventTicket: Item_event_ticket_03dataitemsettingsglobaleventticket;
  itemId: string;
  itemType: string;
  nameOverride: string;
}
export interface Item_event_ticket_03data {
  itemSettings: Item_event_ticket_03dataitemsettings;
  templateId: string;
}
export interface Item_event_ticket_03Entry {
...
export interface Item_event_ticket_04dataitemsettingsglobaleventticket {
  backgroundImageUrl: string;
  clientEventEndTimeUtcMs: string;
  clientEventStartTimeUtcMs: string;
  detailsLinkKey: string;
  ...
  giftable: boolean;
  giftItem: string;
  iconRewards: (Item_event_ticket_04dataitemsettingsglobaleventticketiconrewardsitem)[];
  itemBagDescriptionKey: string;
  textRewardsKey: string;
}
export interface Item_event_ticket_04dataitemsettings {
  category: string;
  descriptionOverride: string;
  globalEventTicket: Item_event_ticket_04dataitemsettingsglobaleventticket;
  itemId: string;
  itemType: string;
  nameOverride: string;
}
export interface Item_event_ticket_04data {
  itemSettings: Item_event_ticket_04dataitemsettings;
  templateId: string;
}
export interface Item_event_ticket_04Entry {
...
export interface Item_event_ticket_04_to_giftdata {
  itemSettings: Item_event_ticket_04_to_giftdataitemsettings;
  templateId: string;
}
...
export interface Item_event_ticket_05dataitemsettingsglobaleventticket {
  backgroundImageUrl: string;
  clientEventEndTimeUtcMs: string;
  clientEventStartTimeUtcMs: string;
  detailsLinkKey: string;
  ...
  giftable: boolean;
  giftItem: string;
  iconRewards: (Item_event_ticket_05dataitemsettingsglobaleventticketiconrewardsitem)[];
  itemBagDescriptionKey: string;
  textRewardsKey: string;
}
export interface Item_event_ticket_05dataitemsettings {
  category: string;
  descriptionOverride: string;
  globalEventTicket: Item_event_ticket_05dataitemsettingsglobaleventticket;
  itemId: string;
  itemType: string;
  nameOverride: string;
}
export interface Item_event_ticket_05data {
  itemSettings: Item_event_ticket_05dataitemsettings;
  templateId: string;
}
export interface Item_event_ticket_05Entry {
...
export interface Item_event_ticket_05_to_giftdataitemsettings {
  category: string;
  descriptionOverride: string;
  globalEventTicket: Item_event_ticket_05_to_giftdataitemsettingsglobaleventticket;
  ignoreInventorySpace: boolean;
  itemId: string;
  itemType: string;
  nameOverride: string;
}
export interface Item_event_ticket_05_to_giftdata {
  itemSettings: Item_event_ticket_05_to_giftdataitemsettings;
  templateId: string;
}
...
export interface Item_event_ticket_07dataitemsettingsglobaleventticket {
  backgroundImageUrl: string;
  clientEventEndTimeUtcMs: string;
  clientEventStartTimeUtcMs: string;
  detailsLinkKey: string;
  ...
  giftable: boolean;
  giftItem: string;
  iconRewards: (Item_event_ticket_07dataitemsettingsglobaleventticketiconrewardsitem)[];
  itemBagDescriptionKey: string;
  textRewardsKey: string;
}
export interface Item_event_ticket_07dataitemsettings {
  category: string;
  descriptionOverride: string;
  globalEventTicket: Item_event_ticket_07dataitemsettingsglobaleventticket;
  itemId: string;
  itemType: string;
  nameOverride: string;
}
export interface Item_event_ticket_07data {
  itemSettings: Item_event_ticket_07dataitemsettings;
  templateId: string;
}
...
export interface Item_event_ticket_08dataitemsettingsglobaleventticketiconrewardsitemneutralavataritemtemplate {
  displayTemplateId: string;
}
export interface Item_event_ticket_08dataitemsettingsglobaleventticketiconrewardsitempokemonencounterpokemondisplay {
  form: string;
  shiny: boolean;
}
export interface Item_event_ticket_08dataitemsettingsglobaleventticketiconrewardsitempokemonencounter {
  pokemonDisplay: Item_event_ticket_08dataitemsettingsglobaleventticketiconrewardsitempokemonencounterpokemondisplay;
  pokemonId: string;
}
export interface Item_event_ticket_08dataitemsettingsglobaleventticketiconrewardsitem {
  candy?: Item_event_ticket_08dataitemsettingsglobaleventticketiconrewardsitemcandy;
  neutralAvatarItemTemplate?: Item_event_ticket_08dataitemsettingsglobaleventticketiconrewardsitemneutralavataritemtemplate;
  pokemonEncounter?: Item_event_ticket_08dataitemsettingsglobaleventticketiconrewardsitempokemonencounter;
  "type": string;
}
export interface Item_event_ticket_08dataitemsettingsglobaleventticket {
  backgroundImageUrl: string;
  clientEventEndTimeUtcMs: string;
  clientEventStartTimeUtcMs: string;
  detailsLinkKey: string;
  ...
  giftable: boolean;
  giftItem: string;
  iconRewards: (Item_event_ticket_08dataitemsettingsglobaleventticketiconrewardsitem)[];
  itemBagDescriptionKey: string;
  textRewardsKey: string;
}
export interface Item_event_ticket_08dataitemsettings {
  category: string;
  descriptionOverride: string;
  globalEventTicket: Item_event_ticket_08dataitemsettingsglobaleventticket;
  itemId: string;
  itemType: string;
}
export interface Item_event_ticket_08data {
  itemSettings: Item_event_ticket_08dataitemsettings;
  templateId: string;
}
export interface Item_event_ticket_08Entry {
...
export interface Item_event_ticket_09dataitemsettingsglobaleventticketiconrewardsitem {
  item: Item_event_ticket_09dataitemsettingsglobaleventticketiconrewardsitemitem;
  "type": string;
}
export interface Item_event_ticket_09dataitemsettingsglobaleventticket {
  backgroundImageUrl: string;
  clientEventEndTimeUtcMs: string;
  clientEventStartTimeUtcMs: string;
  detailsLinkKey: string;
  ...
  giftable: boolean;
  giftItem: string;
  iconRewards: (Item_event_ticket_09dataitemsettingsglobaleventticketiconrewardsitem)[];
  itemBagDescriptionKey: string;
  textRewardsKey: string;
}
export interface Item_event_ticket_09dataitemsettings {
  category: string;
  descriptionOverride: string;
  globalEventTicket: Item_event_ticket_09dataitemsettingsglobaleventticket;
  itemId: string;
  itemType: string;
  nameOverride: string;
}
export interface Item_event_ticket_09data {
  itemSettings: Item_event_ticket_09dataitemsettings;
  templateId: string;
}
...
export interface Item_event_ticket_10dataitemsettingsglobaleventticketiconrewardsitempokemonencounter {
  pokemonDisplay: Item_event_ticket_10dataitemsettingsglobaleventticketiconrewardsitempokemonencounterpokemondisplay;
  pokemonId: string;
}
export interface Item_event_ticket_10dataitemsettingsglobaleventticketiconrewardsitem {
  pokemonEncounter: Item_event_ticket_10dataitemsettingsglobaleventticketiconrewardsitempokemonencounter;
  "type": string;
}
export interface Item_event_ticket_10dataitemsettingsglobaleventticket {
  backgroundImageUrl: string;
  clientEventEndTimeUtcMs: string;
  clientEventStartTimeUtcMs: string;
  detailsLinkKey: string;
  ...
  iconRewards: (Item_event_ticket_10dataitemsettingsglobaleventticketiconrewardsitem)[];
  itemBagDescriptionKey: string;
  textRewardsKey: string;
  titleImageUrl: string;
}
export interface Item_event_ticket_10dataitemsettings {
  category: string;
  descriptionOverride: string;
  globalEventTicket: Item_event_ticket_10dataitemsettingsglobaleventticket;
  itemId: string;
  itemType: string;
  nameOverride: string;
}
export interface Item_event_ticket_10data {
  itemSettings: Item_event_ticket_10dataitemsettings;
  templateId: string;
}
...
export interface Item_event_ticket_graydataitemsettingsglobaleventticket {
  backgroundImageUrl: string;
  clientEventEndTimeUtcMs: string;
  clientEventStartTimeUtcMs: string;
  detailsLinkKey: string;
  ...
  giftable: boolean;
  giftItem: string;
  iconRewards: (Item_event_ticket_graydataitemsettingsglobaleventticketiconrewardsitem)[];
  itemBagDescriptionKey: string;
  textRewardsKey: string;
}
export interface Item_event_ticket_graydataitemsettings {
  category: string;
  descriptionOverride: string;
  globalEventTicket: Item_event_ticket_graydataitemsettingsglobaleventticket;
  itemId: string;
  itemType: string;
  nameOverride: string;
}
export interface Item_event_ticket_graydata {
  itemSettings: Item_event_ticket_graydataitemsettings;
  templateId: string;
}
export interface Item_event_ticket_grayEntry {
  templateId: "ITEM_EVENT_TICKET_GRAY";
  data: Item_event_ticket_graydata;
}
export interface Item_event_ticket_pinkdataitemsettingsglobaleventticketiconrewardsitempokemonencounter {
  pokemonDisplay?: Item_event_ticket_03dataitemsettingsglobaleventticketiconrewardsitempokemonencounterpokemondisplay;
  pokemonId: string;
}
export interface Item_event_ticket_pinkdataitemsettingsglobaleventticketiconrewardsitem {
  item?: Item_event_ticket_03dataitemsettingsglobaleventticketiconrewardsitemitem;
  pokemonEncounter?: Item_event_ticket_pinkdataitemsettingsglobaleventticketiconrewardsitempokemonencounter;
  "type": string;
}
export interface Item_event_ticket_pinkdataitemsettingsglobaleventticket {
  backgroundImageUrl: string;
  clientEventEndTimeUtcMs: string;
  clientEventStartTimeUtcMs: string;
  detailsLinkKey: string;
  ...
  giftable: boolean;
  giftItem: string;
  iconRewards: (Item_event_ticket_pinkdataitemsettingsglobaleventticketiconrewardsitem)[];
  itemBagDescriptionKey: string;
  textRewardsKey: string;
}
export interface Item_event_ticket_pinkdataitemsettings {
  category: string;
  descriptionOverride: string;
  globalEventTicket: Item_event_ticket_pinkdataitemsettingsglobaleventticket;
  itemId: string;
  itemType: string;
}
export interface Item_event_ticket_pinkdata {
  itemSettings: Item_event_ticket_pinkdataitemsettings;
  templateId: string;
}
export interface Item_event_ticket_pinkEntry {
...
export interface Item_giovanni_mapdataitemsettings {
  category: string;
  dropTrainerLevel: number;
  incidentTicket: Item_giovanni_mapdataitemsettingsincidentticket;
  itemId: string;
  itemType: string;
}
export interface Item_giovanni_mapdata {
  itemSettings: Item_giovanni_mapdataitemsettings;
  templateId: string;
}
export interface Item_giovanni_mapEntry {
...
export interface Item_golden_pinap_berrydataitemsettings {
  category: string;
  dropTrainerLevel: number;
  food: Item_golden_pinap_berrydataitemsettingsfood;
  itemId: string;
  itemType: string;
}
export interface Item_golden_pinap_berrydata {
  itemSettings: Item_golden_pinap_berrydataitemsettings;
  templateId: string;
}
export interface Item_golden_pinap_berryEntry {
  templateId: "ITEM_GOLDEN_PINAP_BERRY";
  data: Item_golden_pinap_berrydata;
}
export interface Item_golden_razz_berryEntry {
...
export interface Item_hyper_potiondataitemsettings {
  category: string;
  dropTrainerLevel: number;
  itemId: string;
  itemType: string;
  potion: Item_hyper_potiondataitemsettingspotion;
}
export interface Item_hyper_potiondata {
  itemSettings: Item_hyper_potiondataitemsettings;
  templateId: string;
}
export interface Item_hyper_potionEntry {
...
export interface Item_incense_beluga_boxdataitemsettings {
  category: string;
  dropTrainerLevel: number;
  incense: Item_incense_beluga_boxdataitemsettingsincense;
  itemId: string;
  itemType: string;
}
export interface Item_incense_beluga_boxdata {
  itemSettings: Item_incense_beluga_boxdataitemsettings;
  templateId: string;
}
...
export interface Item_incense_daily_adventuredata {
  itemSettings: Item_incense_daily_adventuredataitemsettings;
  templateId: string;
}
export interface Item_incense_daily_adventureEntry {
  templateId: "ITEM_INCENSE_DAILY_ADVENTURE";
  data: Item_incense_daily_adventuredata;
}
export interface Item_incense_day_bonusEntry {
  templateId: "ITEM_INCENSE_DAY_BONUS";
  data: Item_incense_daily_adventuredata;
}
export interface Item_incense_night_bonusEntry {
  templateId: "ITEM_INCENSE_NIGHT_BONUS";
  data: Item_incense_daily_adventuredata;
}
export interface Item_incense_ordinarydataitemsettingsincense {
  incenseLifetimeSeconds: number;
}
export interface Item_incense_ordinarydataitemsettings {
  category: string;
  dropTrainerLevel: number;
  incense: Item_incense_ordinarydataitemsettingsincense;
  itemId: string;
  itemType: string;
}
export interface Item_incense_ordinarydata {
  itemSettings: Item_incense_ordinarydataitemsettings;
  templateId: string;
}
export interface Item_incense_ordinaryEntry {
...
export interface Item_incubator_basicdataitemsettings {
  category: string;
  dropTrainerLevel: number;
  eggIncubator: Item_incubator_basicdataitemsettingseggincubator;
  itemId: string;
  itemType: string;
}
export interface Item_incubator_basicdata {
  itemSettings: Item_incubator_basicdataitemsettings;
  templateId: string;
}
...
export interface Item_incubator_basic_unlimiteddataitemsettings {
  category: string;
  dropTrainerLevel: number;
  eggIncubator: Item_incubator_basic_unlimiteddataitemsettingseggincubator;
  itemId: string;
  itemType: string;
}
export interface Item_incubator_basic_unlimiteddata {
  itemSettings: Item_incubator_basic_unlimiteddataitemsettings;
  templateId: string;
}
export interface Item_incubator_basic_unlimitedEntry {
  templateId: "ITEM_INCUBATOR_BASIC_UNLIMITED";
  data: Item_incubator_basic_unlimiteddata;
}
export interface Item_incubator_specialdataitemsettings {
  category: string;
  dropTrainerLevel: number;
  eggIncubator: Item_incubator_basic_unlimiteddataitemsettingseggincubator;
  hideItemInInventory: boolean;
...
export interface Item_incubator_specialdata {
  itemSettings: Item_incubator_specialdataitemsettings;
  templateId: string;
}
...
export interface Item_incubator_timeddataitemsettingseggincubator {
  distanceMultiplier: number;
  expiredIncubatorReplacement: Item_incubator_timeddataitemsettingseggincubatorexpiredincubatorreplacement;
  incubatorType: string;
  maxHatchSummaryEntries: number;
  useBonusIncubatorAttributes: boolean;
}
export interface Item_incubator_timeddataitemsettings {
  category: string;
  dropTrainerLevel: number;
  eggIncubator: Item_incubator_timeddataitemsettingseggincubator;
  itemId: string;
  itemType: string;
}
export interface Item_incubator_timeddata {
  itemSettings: Item_incubator_timeddataitemsettings;
  templateId: string;
}
export interface Item_incubator_timedEntry {
  templateId: "ITEM_INCUBATOR_TIMED";
  data: Item_incubator_timeddata;
}
export interface Item_item_storage_upgradedataitemsettingsinventoryupgrade {
  additionalStorage: number;
  upgradeType: string;
}
export interface Item_item_storage_upgradedataitemsettings {
  category: string;
  dropTrainerLevel: number;
  inventoryUpgrade: Item_item_storage_upgradedataitemsettingsinventoryupgrade;
  itemId: string;
  itemType: string;
}
export interface Item_item_storage_upgradedata {
  itemSettings: Item_item_storage_upgradedataitemsettings;
  templateId: string;
}
export interface Item_item_storage_upgradeEntry {
...
export interface Item_leader_map_fragmentdataitemsettings {
  category: string;
  dropTrainerLevel: number;
  incidentTicket: Item_leader_map_fragmentdataitemsettingsincidentticket;
  itemId: string;
  itemType: string;
}
export interface Item_leader_map_fragmentdata {
  itemSettings: Item_leader_map_fragmentdataitemsettings;
  templateId: string;
}
...
export interface Item_lucky_eggdataitemsettings {
  category: string;
  dropTrainerLevel: number;
  itemId: string;
  itemType: string;
  xpBoost: Item_lucky_eggdataitemsettingsxpboost;
}
export interface Item_lucky_eggdata {
  itemSettings: Item_lucky_eggdataitemsettings;
  templateId: string;
}
export interface Item_lucky_eggEntry {
  templateId: "ITEM_LUCKY_EGG";
  data: Item_lucky_eggdata;
}
export interface Item_lucky_friend_applicatordataitemsettings {
  category: string;
  itemId: string;
  itemType: string;
}
export interface Item_lucky_friend_applicatordata {
  itemSettings: Item_lucky_friend_applicatordataitemsettings;
  templateId: string;
}
export interface Item_lucky_friend_applicatorEntry {
...
export interface Item_max_potiondataitemsettings {
  category: string;
  dropTrainerLevel: number;
  itemId: string;
  itemType: string;
  potion: Item_max_potiondataitemsettingspotion;
}
export interface Item_max_potiondata {
  itemSettings: Item_max_potiondataitemsettings;
  templateId: string;
}
export interface Item_max_potionEntry {
  templateId: "ITEM_MAX_POTION";
  data: Item_max_potiondata;
}
export interface Item_max_revivedataitemsettings {
  category: string;
  dropTrainerLevel: number;
  itemId: string;
  itemType: string;
  revive: Item_max_potiondataitemsettingspotion;
}
export interface Item_max_revivedata {
  itemSettings: Item_max_revivedataitemsettings;
  templateId: string;
}
export interface Item_max_reviveEntry {
...
export interface Item_move_reroll_other_special_attack_adata {
  itemSettings: Item_move_reroll_other_special_attack_adataitemsettings;
  templateId: string;
}
export interface Item_move_reroll_other_special_attack_aEntry {
...
export interface Item_mpdata {
  itemSettings: Item_mpdataitemsettings;
  templateId: string;
}
...
export interface Item_mp_replenishdataitemsettings {
  category: string;
  dropTrainerLevel: number;
  itemCap: number;
  itemId: string;
  itemType: string;
  replenishMp: Item_mp_replenishdataitemsettingsreplenishmp;
}
export interface Item_mp_replenishdata {
  itemSettings: Item_mp_replenishdataitemsettings;
  templateId: string;
}
...
export interface Item_other_evolution_stone_maple_adata {
  itemSettings: Item_other_evolution_stone_maple_adataitemsettings;
  templateId: string;
}
export interface Item_other_evolution_stone_maple_aEntry {
  templateId: "ITEM_OTHER_EVOLUTION_STONE_MAPLE_A";
  data: Item_other_evolution_stone_maple_adata;
}
export interface Item_other_evolution_stone_maple_bEntry {
  templateId: "ITEM_OTHER_EVOLUTION_STONE_MAPLE_B";
  data: Item_other_evolution_stone_maple_adata;
}
export interface Item_other_evolution_stone_maple_cEntry {
...
export interface Item_poffindataitemsettings {
  category: string;
  food: Item_poffindataitemsettingsfood;
  itemId: string;
  itemType: string;
}
export interface Item_poffindata {
  itemSettings: Item_poffindataitemsettings;
  templateId: string;
}
export interface Item_poffinEntry {
...
export interface Item_postcard_inventorydata {
  itemSettings: Item_postcard_inventorydataitemsettings;
  templateId: string;
}
...
export interface Item_resource_crowned_zaciandata {
  itemSettings: Item_resource_crowned_zaciandataitemsettings;
  templateId: string;
}
export interface Item_resource_crowned_zacianEntry {
  templateId: "ITEM_RESOURCE_CROWNED_ZACIAN";
  data: Item_resource_crowned_zaciandata;
}
export interface Item_resource_crowned_zamazentaEntry {
...
export interface Item_single_stat_increasedataitemsettings {
  category: string;
  ignoreInventorySpace: boolean;
  itemId: string;
  itemType: string;
  statIncrease: Item_single_stat_increasedataitemsettingsstatincrease;
}
export interface Item_single_stat_increasedata {
  itemSettings: Item_single_stat_increasedataitemsettings;
  templateId: string;
}
export interface Item_single_stat_increaseEntry {
...
export interface Item_star_piecedataitemsettings {
  category: string;
  dropTrainerLevel: number;
  itemId: string;
  itemType: string;
  stardustBoost: Item_star_piecedataitemsettingsstardustboost;
}
export interface Item_star_piecedata {
  itemSettings: Item_star_piecedataitemsettings;
  templateId: string;
}
...
export interface Item_ticket_city_safari_00dataitemsettings {
  category: string;
  globalEventTicket: Item_ticket_city_safari_00dataitemsettingsglobaleventticket;
  itemId: string;
  itemType: string;
}
export interface Item_ticket_city_safari_00data {
  itemSettings: Item_ticket_city_safari_00dataitemsettings;
  templateId: string;
}
export interface Item_ticket_city_safari_00Entry {
  templateId: "ITEM_TICKET_CITY_SAFARI_00";
  data: Item_ticket_city_safari_00data;
}
export interface Item_ticket_city_safari_01Entry {
  templateId: "ITEM_TICKET_CITY_SAFARI_01";
  data: Item_ticket_city_safari_00data;
}
export interface Item_ticket_city_safari_02Entry {
  templateId: "ITEM_TICKET_CITY_SAFARI_02";
  data: Item_ticket_city_safari_00data;
}
export interface Item_ticket_city_safari_04dataitemsettings {
  category: string;
  descriptionOverride: string;
  globalEventTicket: Item_ticket_city_safari_00dataitemsettingsglobaleventticket;
  ignoreInventorySpace: boolean;
...
export interface Item_ticket_city_safari_04data {
  itemSettings: Item_ticket_city_safari_04dataitemsettings;
  templateId: string;
}
export interface Item_ticket_city_safari_04Entry {
...
export interface Item_troy_disk_sparklydata {
  itemSettings: Item_troy_disk_sparklydataitemsettings;
  templateId: string;
}
export interface Item_troy_disk_sparklyEntry {
...
export interface ItemsSettingsMasterfileByTemplateId {
  ...
  "ITEM_EVENT_PASS_POINT_LIVE_OPS_03": Item_event_pass_point_live_ops_03Entry;
