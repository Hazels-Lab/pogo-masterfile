...
import type { TappableSettings } from "./index";
...
export type TappableSettingsSettings = S<
	...
	>
>;
export type TappableSettingsSettingsBreakfast = S<
	TappableSettings<
	...
	>
>;
export type TappableSettingsTypeHat = S<
	TappableSettings<
		"TAPPABLE_TYPE_HAT",
		{
			removeWhenTapped: true;
	...
	>
>;
export type TappableSettingsTypeMaple = S<
	TappableSettings<
		"TAPPABLE_TYPE_MAPLE",
		{
			removeWhenTapped: true;
	...
	>
>;
export type TappableSettingsTypePokeball = S<
	TappableSettings<
