...
export type CommerceCategoriesMasterfileEntry = Iap_category_avatarEntry | Iap_category_bundleEntry | Iap_category_flair_bundleEntry | Iap_category_transporter_energyEntry | Iap_category_freeEntry | Iap_category_itemsEntry | Iap_category_pokecoinsEntry | Iap_category_team_changeEntry | Iap_category_upgradesEntry | Iap_category_global_event_ticketEntry | Iap_category_noneEntry | Iap_category_rewarded_spendEntry | Iap_category_stickerEntry;
