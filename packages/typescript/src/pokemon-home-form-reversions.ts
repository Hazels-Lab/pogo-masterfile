export interface PokemonHomeFormReversions<
	...
	TData extends PokemonHomeFormReversionsData = PokemonHomeFormReversionsData,
> {
...
export interface PokemonHomeFormReversionsData {
	formMapping?: Array<{
		...
		unauthorizedForms: Array<string>;
	}>;
	pokemonId?: string;
}

export type PokemonHomeFormReversionsV0351PokemonCastformHomeFormReversion = PokemonHomeFormReversions<
...
>;
export type PokemonHomeFormReversionsV0421CherrimHomeFormReversion = PokemonHomeFormReversions<
...
>;
export type PokemonHomeFormReversionsV0487PokemonGiratinaHomeReversion = PokemonHomeFormReversions<
...
>;
export type PokemonHomeFormReversionsV0555PokemonDarmanitanHomeFormReversion = PokemonHomeFormReversions<
...
>;
export type PokemonHomeFormReversionsV0647PokemonKeldeoHomeFormReversion = PokemonHomeFormReversions<
...
>;
export type PokemonHomeFormReversionsV0648PokemonMeloettaHomeFormReversion = PokemonHomeFormReversions<
...
>;
export type PokemonHomeFormReversionsV0649PokemonGenesectHomeFormReversion = PokemonHomeFormReversions<
