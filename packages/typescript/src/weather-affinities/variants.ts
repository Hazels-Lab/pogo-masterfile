...
import type { WeatherAffinities } from "./index";
...
export type WeatherAffinitiesClear = S<
	...
	>
>;
export type WeatherAffinitiesFog = S<
	WeatherAffinities<
	...
	>
>;
export type WeatherAffinitiesOvercast = S<
	WeatherAffinities<
	...
	>
>;
export type WeatherAffinitiesPartlyCloudy = S<
	WeatherAffinities<
	...
	>
>;
export type WeatherAffinitiesRainy = S<
	WeatherAffinities<
	...
	>
>;
export type WeatherAffinitiesSnow = S<
	WeatherAffinities<
	...
	>
>;
export type WeatherAffinitiesWindy = S<
	WeatherAffinities<
