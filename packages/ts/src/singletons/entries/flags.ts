...
export type SingletonsFlagsMasterfileEntry = ArPhotoFeatureFlags | AvatarFeatureFlags | AvatarStoreFooterFlags | AvatarStoreSubcategoryFilteringFlags | BreadFeatureFlags | Pokedexv2FeatureFlags;
