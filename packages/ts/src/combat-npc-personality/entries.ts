...
import type { CombatNpcPersonality, CombatNpcPersonalityData } from "./index";

export type CombatNpcPersonalityEasy = S<CombatNpcPersonality<"TRAINER_PERSONALITY_EASY", {
    offensiveMaximumScore: 0.75;
    offensiveMinimumScore: 0.5;
    specialChance: 0.33;
    superEffectiveChance: 0.25;
}>>;
export type CombatNpcPersonalityHard = S<CombatNpcPersonality<"TRAINER_PERSONALITY_HARD", {
...
export type CombatNpcPersonalityMedium = S<CombatNpcPersonality<"TRAINER_PERSONALITY_MEDIUM", {
    offensiveMaximumScore: 1;
