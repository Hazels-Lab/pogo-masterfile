// Generated from Pokémon GO masterfile — group "avatarItemDisplay", split "display-string-id/shoes", 162 entries.
...
export type AvatarItemDisplayNShoesAcetrainersmB0 = S<
	...
	>
>;
export type AvatarItemDisplayNShoesAdidas = S<
	AvatarItemDisplay<
		"N_DISPLAY_n_shoes_adidas",
		{
			displayStringId: "avatar_shoes_adidas2026";
			iconAddress: "n_shoes_adidas_icon";
		}
	>
>;
...
export type AvatarItemDisplayNShoesWcs2024winnersitems0 = S<
	...
	>
>;
export type AvatarItemDisplayNShoesWcs2026winnersitems = S<
	AvatarItemDisplay<
		"N_DISPLAY_n_shoes_wcs2026winnersitems",
		{
			displayStringId: "avatar_shoes_wcs2026champion";
			iconAddress: "n_shoes_wcs2026winnersitems_icon";
		}
	>
>;
export type AvatarItemDisplayNShoesWillow = S<
	AvatarItemDisplay<
		"N_DISPLAY_n_shoes_willow",
		{
			displayStringId: "avatar_shirt_default_willow_shoes";
			iconAddress: "n_shoes_willow_icon";
		}
	>
>;
