...
import type { CombatNpcTrainer, CombatNpcTrainerData } from "./index";

export type CombatNpcTrainerBlancheGreat = S<CombatNpcTrainer<"TRAINER_BLANCHE_GREAT", {
    availablePokemon: [
        {
            pokemonDisplay: {
                form: "SNEASEL_NORMAL";
...
export type CombatNpcTrainerBlancheMaster = S<CombatNpcTrainer<"TRAINER_BLANCHE_MASTER", {
    availablePokemon: [
        {
            pokemonType: "SUICUNE";
        },
...
export type CombatNpcTrainerBlancheUltra = S<CombatNpcTrainer<"TRAINER_BLANCHE_ULTRA", {
    availablePokemon: [
        {
            pokemonType: "GLACEON";
        },
...
export type CombatNpcTrainerCandelaGreat = S<CombatNpcTrainer<"TRAINER_CANDELA_GREAT", {
    availablePokemon: [
        {
...
export type CombatNpcTrainerCandelaMaster = S<CombatNpcTrainer<"TRAINER_CANDELA_MASTER", {
    availablePokemon: [
        {
            pokemonType: "ENTEI";
        },
...
export type CombatNpcTrainerCandelaUltra = S<CombatNpcTrainer<"TRAINER_CANDELA_ULTRA", {
    availablePokemon: [
        {
            pokemonType: "FLAREON";
        },
...
export type CombatNpcTrainerSparkGreat = S<CombatNpcTrainer<"TRAINER_SPARK_GREAT", {
    availablePokemon: [
        {
            pokemonType: "PLUSLE";
        },
...
export type CombatNpcTrainerSparkMaster = S<CombatNpcTrainer<"TRAINER_SPARK_MASTER", {
    availablePokemon: [
        {
            pokemonType: "RAIKOU";
        },
...
export type CombatNpcTrainerSparkUltra = S<CombatNpcTrainer<"TRAINER_SPARK_ULTRA", {
    availablePokemon: [
        {
            pokemonType: "JOLTEON";
        },
...
export type CombatNpcTrainerMasterfileEntry = CombatNpcTrainerBlancheGreat | CombatNpcTrainerBlancheMaster | CombatNpcTrainerBlancheUltra | CombatNpcTrainerCandelaGreat | CombatNpcTrainerCandelaMaster | CombatNpcTrainerCandelaUltra | CombatNpcTrainerSparkGreat | CombatNpcTrainerSparkMaster | CombatNpcTrainerSparkUltra;
