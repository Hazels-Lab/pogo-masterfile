...
import type { VsSeekerPokemonRewards, VsSeekerPokemonRewardsData } from "./index";

export type VsSeekerPokemonRewardsFree = S<VsSeekerPokemonRewards<"VS_SEEKER_POKEMON_REWARDS_FREE">>;
export type VsSeekerPokemonRewardsPremium = S<VsSeekerPokemonRewards<"VS_SEEKER_POKEMON_REWARDS_PREMIUM", {
    rewardTrack: "PREMIUM";
}>>;
