...
import type { MegaEvoLevelSettingsAltariaMasterfileEntry } from "./altaria";
import type { MegaEvoLevelSettingsBanetteMasterfileEntry } from "./banette";
...
import type { MegaEvoLevelSettingsHoundoomMasterfileEntry } from "./houndoom";
import type { MegaEvoLevelSettingsKyogreMasterfileEntry } from "./kyogre";
import type { MegaEvoLevelSettingsLatiasMasterfileEntry } from "./latias";
import type { MegaEvoLevelSettingsLatiosMasterfileEntry } from "./latios";
import type { MegaEvoLevelSettingsMalamarMasterfileEntry } from "./malamar";
import type { MegaEvoLevelSettingsManectricMasterfileEntry } from "./manectric";
import type { MegaEvoLevelSettingsMedichamMasterfileEntry } from "./medicham";
import type { MegaEvoLevelSettingsMetagrossMasterfileEntry } from "./metagross";
...
export type * from "./altaria";
export type * from "./banette";
...
export type * from "./houndoom";
export type * from "./kyogre";
export type * from "./latias";
export type * from "./latios";
export type * from "./malamar";
export type * from "./manectric";
export type * from "./medicham";
export type * from "./metagross";
...
export type MegaEvoLevelSettingsMasterfileEntry =
	| MegaEvoLevelSettingsAltariaMasterfileEntry
	| MegaEvoLevelSettingsBanetteMasterfileEntry
	...
	| MegaEvoLevelSettingsHoundoomMasterfileEntry
	| MegaEvoLevelSettingsKyogreMasterfileEntry
	| MegaEvoLevelSettingsLatiasMasterfileEntry
	| MegaEvoLevelSettingsLatiosMasterfileEntry
	| MegaEvoLevelSettingsMalamarMasterfileEntry
	| MegaEvoLevelSettingsManectricMasterfileEntry
	| MegaEvoLevelSettingsMedichamMasterfileEntry
	| MegaEvoLevelSettingsMetagrossMasterfileEntry
