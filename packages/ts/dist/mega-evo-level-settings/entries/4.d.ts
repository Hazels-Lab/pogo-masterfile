// Generated from Pokémon GO masterfile — group "megaEvoLevelSettings", split "4", 14 entries.

import type { S } from "../../_utils";
import type { MegaEvoLevelSettings } from "../types";

export type MegaEvoLevelSettings4V0015PokemonBeedrill = S<
	MegaEvoLevelSettings<
		"MEGA_EVOLUTION_LEVEL_4_V0015_POKEMON_BEEDRILL",
		{
			cooldown: {
				bypassCostInitial: 5;
				durationMs: "86400000";
...
export type MegaEvoLevelSettings4V0227PokemonSkarmory = S<
	...
	>
>;
export type MegaEvoLevelSettings4V0229PokemonHoundoom = S<
	MegaEvoLevelSettings<
		"MEGA_EVOLUTION_LEVEL_4_V0229_POKEMON_HOUNDOOM",
		{
			cooldown: {
				bypassCostInitial: 5;
				durationMs: "86400000";
...
export type MegaEvoLevelSettings4V0652PokemonChesnaught = S<
	...
	>
>;
export type MegaEvoLevelSettings4V0655PokemonDelphox = S<
	MegaEvoLevelSettings<
	...
	>
>;
export type MegaEvoLevelSettings4V0658PokemonGreninja = S<
	MegaEvoLevelSettings<
...
export type MegaEvoLevelSettings4MasterfileEntry =
	| MegaEvoLevelSettings4V0015PokemonBeedrill
	...
	| MegaEvoLevelSettings4V0229PokemonHoundoom
