...
export type SingletonsSettingsMasterfileEntry = AccessibilitySettings | AdditiveSceneSettings | AddressablePokemonSettings | AddressBookImportSettings | AdvancedSettings | ArTelemetrySettings | BackgroundModeSettings | BattleAnimationSettings | BattleHubBadgeSettings | BattleHubOrderSettings | BattleInputBufferSettings | BattlePartySettings | BattleSettings | BattleVisualSettings | BestFriendsPlusSettings | BreadBattleClientSettings | BreadLobbyCounterSettings | BreadLobbyUpdateSettings | BreadPokemonScalingSettings | BreadSettings | BuddyEncounterCameoSettings | BuddyHungerSettings | BuddyInteractionSettings | BuddySwapSettings | BuddyWalkSettings | BulkHealingSettings | ButterflyCollectorSettings | CampfireSettings | CatchRadiusMultiplierSettings | CombatCompetitiveSeasonSettings | CombatLeagueSettings | CombatSettings | CombatStatStageSettings | ContestSettings | ConversationSettings | CrossGameSocialSettings | DailyAdventureIncenseSettings | DeepLinkingSettings | EggHatchImprovementsSettings | EncounterSettings | EventPlannerPopularNotificationSettings | ExternalAddressableAssetsSettings | FeatureUnlockLevelSettings | GeotargetedQuestSettings | GiftingSettings | GuiSearchSettings | GymBadgeSettings | HapticsSettings | IapSettings | IbfcLightweightSettings | ImpressionTrackingSettings | InAppSurveySettings | IncidentPrioritySettings | IncidentVisibilitySettings | InventorySettings | IrisSocialSettings | IrisSocialUxFunnelSettings | ItemInventoryUpdateSettings | JoinRaidViaFriendListSettings | LanguageSelectorSettings | LuckyPokemonSettings | MapDisplaySettings | MapObjectsInteractionRangeSettings | MegaEvoSettings | MonodepthSettings | MpSettings | NaturalArtDayNightFeatureSettings | NearbyPokemonSettings | NeutralAvatarSettings | OnboardingSettings | PartyDarkLaunchSettings | PartyIapBoostsSettings | PartyRecommendationSettings | PhotoSettings | PlannerSettings | PlayerBonusSystemSettings | PokeballThrowPropertySettings | PokedexCategoriesSettings | PokedexSizeStatsSystemSettings | PokedexV2Settings | PokemonFxSettings | PokemonHomeSettings | PokemonTagSettings | PopupControlSettings | PostcardCollectionSettings | PowerUpPokestopsSettings | PrimalEvoSettings | PtcOauthSettings | QuestDialogueInboxSettings | QuickInviteSettings | RaidEntryCostSettings | RaidLobbyCounterSettings | RaidSettings | ReferralSettings | RemoteTradeSettings | RouteBadgeSettings | RouteCreationSettings | RouteDiscoverySettings | RoutePinSettings | RoutePlaySettings | RoutesNearbyNotifSettings | RoutesPartyPlayInteropSettings | RouteStampCategorySettings | SharedFusionSettings | SharedMoveSettings | SoftSfidaSettings | SourdoughMoveMappingSettings | SpecialEggSettings | SponsoredGeofenceGiftSettings | SquashSettings | StampCollectionSettings | StationedPokemonTableSettings | StickerCategorySettings | StyleShopSettings | TicketGiftingSettings | TodayViewSettings | TutorialSettings | UsernameSuggestionSettings | VerboseLogCombatSettings | VerboseLogRaidSettings | VistaGeneralSettings | VsSeekerClientSettings | VsSeekerScheduleSettings | WeatherBonusSettings;
