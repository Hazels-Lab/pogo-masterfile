...
export type Singletons = AccessibilitySettingsType | AdditiveSceneSettingsType | AddressablePokemonSettingsType | AddressBookImportSettingsType | AdvancedSettingsType | ArPhotoFeatureFlagsType | ArTelemetrySettingsType | AssetRefreshProtoType | AvatarFeatureFlagsType | AvatarStoreFooterFlagsType | AvatarStoreSubcategoryFilteringFlagsType | BackgroundModeSettingsType | BattleAnimationSettingsType | BattleHubBadgeSettingsType | BattleHubOrderSettingsType | BattleInputBufferSettingsType | BattlePartySettingsType | BattleSettingsType | BattleVisualSettingsType | BelugaPokemonWhitelistType | BestFriendsPlusSettingsType | BreadBattleClientSettingsType | BreadFeatureFlagsType | BreadLobbyCounterSettingsType | BreadLobbyUpdateSettingsType | BreadMoveMappingsType | BreadPokemonScalingSettingsType | BreadSettingsType | BuddyEncounterCameoSettingsType | BuddyHungerSettingsType | BuddyInteractionSettingsType | BuddySwapSettingsType | BuddyWalkSettingsType | BulkHealingSettingsType | ButterflyCollectorSettingsType | CampfireSettingsType | CatchRadiusMultiplierSettingsType | CombatCompetitiveSeasonSettingsType | CombatLeagueSettingsType | CombatSettingsType | CombatStatStageSettingsType | ContestSettingsType | ConversationSettingsType | CrossGameSocialSettingsType | DailyAdventureIncenseSettingsType | DeepLinkingSettingsType | EggHatchImprovementsSettingsType | EncounterSettingsType | EventPlannerPopularNotificationSettingsType | ExternalAddressableAssetsSettingsType | FeatureUnlockLevelSettingsType | GeotargetedQuestSettingsType | GiftingSettingsType | GuiSearchSettingsType | GymBadgeSettingsType | HapticsSettingsType | IapSettingsType | IbfcLightweightSettingsType | ImpressionTrackingSettingsType | InAppSurveySettingsType | IncidentPrioritySettingsType | IncidentVisibilitySettingsType | InventorySettingsType | IrisSocialSettingsType | IrisSocialUxFunnelSettingsType | ItemCurrencyValuesType | ItemInventoryUpdateSettingsType | JoinRaidViaFriendListSettingsType | LanguageSelectorSettingsType | LuckyPokemonSettingsType | MainMenuChangesType | MapDisplaySettingsType | MapObjectsInteractionRangeSettingsType | MegaEvoSettingsType | MonodepthSettingsType | MpSettingsType | NaturalArtDayNightFeatureSettingsType | NearbyPokemonSettingsType | NeutralAvatarSettingsType | OnboardingSettingsType | OptimizationsProtoType | PartyDarkLaunchSettingsType | PartyIapBoostsSettingsType | PartyRecommendationSettingsType | PhotoSettingsType | PlannerSettingsType | PlayerBonusSystemSettingsType | PlayerLevelType | PokeballThrowPropertySettingsType | PokecoinPurchaseDisplayGmtType | PokedexCategoriesSettingsType | PokedexSizeStatsSystemSettingsType | Pokedexv2FeatureFlagsType | PokedexV2SettingsType | PokemonFxSettingsType | PokemonHomeSettingsType | PokemonTagSettingsType | PopupControlSettingsType | PostcardCollectionSettingsType | PowerUpPokestopsSettingsType | PrimalEvoSettingsType | PtcOauthSettingsType | QuestDialogueInboxSettingsType | QuickInviteSettingsType | RaidEntryCostSettingsType | RaidLobbyCounterSettingsType | RaidSettingsType | ReferralSettingsType | RemoteTradeSettingsType | RouteBadgeSettingsType | RouteCreationSettingsType | RouteDiscoverySettingsType | RoutePinSettingsType | RoutePlaySettingsType | RoutesNearbyNotifSettingsType | RoutesPartyPlayInteropSettingsType | RouteStampCategorySettingsType | SharedFusionSettingsType | SharedMoveSettingsType | SoftSfidaSettingsType | SourdoughMoveMappingSettingsType | SpecialEggSettingsType | SponsoredGeofenceGiftSettingsType | SquashSettingsType | StampCollectionSettingsType | StationedPokemonTableSettingsType | StickerCategorySettingsType | StyleShopSettingsType | TicketGiftingSettingsType | TodayViewSettingsType | TutorialSettingsType | UsernameSuggestionSettingsType | VerboseLogCombatSettingsType | VerboseLogRaidSettingsType | VistaGeneralSettingsType | VnextBattleConfigType | VsSeekerClientSettingsType | VsSeekerScheduleSettingsType | WeatherBonusSettingsType;
