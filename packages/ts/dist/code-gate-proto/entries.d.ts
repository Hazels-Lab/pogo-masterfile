...
import type { CodeGateProto, CodeGateProtoData } from "./index";

export type CodeGateProtoBattleAccessibilityCodeGate = S<CodeGateProto<"BATTLE_ACCESSIBILITY_CODE_GATE", {
    subCodeGateList: {
        isEnabled: true;
        name: "show_move_effectiveness";
    };
}>>;
export type CodeGateProtoBattleRewardsCodeGate = S<CodeGateProto<"BATTLE_REWARDS_CODE_GATE", {
    subCodeGateList: {
        name: "UNLIMITED_PLAYER_ACTIVITY_REWARDS_SUB_CODE_GATE";
    };
}>>;
export type CodeGateProtoCombatVnextCodeGate = S<CodeGateProto<"COMBAT_VNEXT_CODE_GATE", {
    subCodeGateList: {
        isEnabled: true;
...
export type CodeGateProtoInputTrackerCodeGate = S<CodeGateProto<"INPUT_TRACKER_CODE_GATE", {
    subCodeGateList: {
        isEnabled: true;
...
export type CodeGateProtoMasterfileEntry = CodeGateProtoBattleAccessibilityCodeGate | CodeGateProtoBattleRewardsCodeGate | CodeGateProtoCombatVnextCodeGate | CodeGateProtoIbfcLwsCodeGate | CodeGateProtoInputTrackerCodeGate | CodeGateProtoIsSkuAvailableNoAppIdCodeGate | CodeGateProtoMapThemeLowPerfCodeGate | CodeGateProtoPredictChargeMoveOnSubmitRollBackCodeGate | CodeGateProtoPushGatewayMultiActionCodeGate | CodeGateProtoStampCollectionSnapshotEnabledCodeGate | CodeGateProtoTodayViewV3CodeGate | CodeGateProtoUseExtendedSettingsForMaxScaleCodeGate | CodeGateProtoUseGmtSkuDataCodeGate;
