...
import type { AvatarGroupOrderSettings, AvatarGroupOrderSettingsData } from "./index";

export type AvatarGroupOrderSettingsOrderSettings = S<AvatarGroupOrderSettings<"AVATAR_GROUP_ORDER_SETTINGS", {
    group: [
        {
            name: "group_uniqlo";
            order: 3;
...
export type AvatarGroupOrderSettingsSettings = S<AvatarGroupOrderSettings<"AVATAR_GROUP_SETTINGS", {
    group: [
        {
            name: "group_uniqlo";
            order: 1;
