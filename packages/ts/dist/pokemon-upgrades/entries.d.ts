...
import type { PokemonUpgrades, PokemonUpgradesData } from "./index";

export type PokemonUpgradesOverrideSettingsV0890PokemonEternatus = S<PokemonUpgrades<"POKEMON_UPGRADE_OVERRIDE_SETTINGS_V0890_POKEMON_ETERNATUS", {
    candyCost: [
        30,
        30,
        30,
...
export type PokemonUpgradesSettings = S<PokemonUpgrades<"POKEMON_UPGRADE_SETTINGS", {
    candyCost: [
        1,
        1,
        1,
