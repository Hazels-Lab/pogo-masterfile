...
export type CombatLeagueDefaultGreat = S<CombatLeague<"COMBAT_LEAGUE_DEFAULT_GREAT", {
    allowTempEvos: true;
...
export type CombatLeagueDefaultMaster = S<CombatLeague<"COMBAT_LEAGUE_DEFAULT_MASTER", {
    allowTempEvos: true;
...
export type CombatLeagueDefaultUltra = S<CombatLeague<"COMBAT_LEAGUE_DEFAULT_ULTRA", {
    allowTempEvos: true;
