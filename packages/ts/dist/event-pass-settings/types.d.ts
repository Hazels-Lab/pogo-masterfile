...
export interface EventPassSettingsData {
	...
	eventPassDisplaySettings: {
		eventPassTitleKey: "season_pass_base_track_title_aug" | "season_pass_base_track_title_uu_water_festival_2026" | "season_pass_base_track_title_WCS_2026";
		eventPassTrackUpgradeDescriptions: [
			{
				detailsLinkKey: "season_pass_details_link_august2026" | "season_pass_details_link_uu_water_festival_2026" | "season_pass_details_link_WCS_2026";
				eventDurationKey: "season_pass_august2026_event_duration" | "season_pass_uu_water_festival_2026_event_duration" | "season_pass_WCS_2026_event_duration";
				...
				upgradeDescriptionKey:
					...
					| "season_pass_WCS_2026_upgrade_description";
			},
		];
		headerIconUrl:
		...
		premiumRewardBannerBottom:
			...
			| "event_pass_premium_reward_banner_bottom_text_bugoutbuddies2026"
			| "event_pass_premium_reward_banner_bottom_text_rank_15_reward";
		...
		premiumRewardBannerMiddle: "avatar_backpack_starmie" | "avatar_backpack_wcspxp" | "event_pass_premium_reward_banner_middle_text";
		sectionDisplayPriority: number;
	};
	expirationTime: "2026-08-24T20:00:00" | "2026-08-30T20:00:00" | "2026-09-08T10:00:00";
	gracePeriodEndTime: "2026-08-26T20:00:00" | "2026-09-01T20:00:00" | "2026-09-10T10:00:00";
	maxTierLevel: number;
	pointsItemId: "ITEM_EVENT_PASS_POINT_LIVE_OPS_07" | "ITEM_EVENT_PASS_POINT_LIVE_OPS_10" | "ITEM_EVENT_PASS_POINT_MONTHLY_03";
	trackConditions: [
		{
			track: "FREE";
			trackTitleKey: "season_pass_base_track_title_aug" | "season_pass_base_track_title_uu_water_festival_2026" | "season_pass_base_track_title_WCS_2026";
		},
		{
			badge: "BADGE_EVENT_0192" | "BADGE_EVENT_0201" | "BADGE_EVENT_0231";
			track: "PREMIUM";
			trackTitleKey:
				| "season_pass_premium_track_title_aug"
				| "season_pass_premium_track_title_uu_water_festival_2026"
				| "season_pass_premium_track_title_WCS_2026";
		},
	];
}
