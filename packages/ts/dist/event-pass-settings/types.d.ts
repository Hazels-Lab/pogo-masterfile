...
export interface EventPassSettingsData {
	...
	eventPassDisplaySettings: {
		eventPassTitleKey: "season_pass_base_track_title_10th_anniversary_2026" | "season_pass_base_track_title_july";
		eventPassTrackUpgradeDescriptions: [
			{
				detailsLinkKey: "season_pass_details_link_afterparty_2026" | "season_pass_details_link_july2026";
				eventDurationKey: "season_pass_after_party_2026_event_duration" | "season_pass_july2026_event_duration";
				...
				trackUnlockSkuId: "pgorelease.july2_deluxe_event_pass_track_unlock" | "pgorelease.month2_deluxe_event_pass_track_unlock";
				upgradeDescriptionKey: "season_pass_after_party_2026_upgrade_description" | "season_pass_july2026_upgrade_description";
			},
		];
	...
	expirationTime: "2026-07-27T20:00:00" | "2026-08-04T10:00:00";
	gracePeriodEndTime: "2026-07-29T20:00:00" | "2026-08-06T10:00:00";
	maxTierLevel: number;
	pointsItemId: "ITEM_EVENT_PASS_POINT_LIVE_OPS_08" | "ITEM_EVENT_PASS_POINT_MONTHLY_02";
	trackConditions: [
		{
			track: "FREE";
			trackTitleKey: "season_pass_base_track_title_10th_anniversary_2026" | "season_pass_base_track_title_july";
		},
		{
			badge: "BADGE_EVENT_0191" | "BADGE_EVENT_0208";
			track: "PREMIUM";
			trackTitleKey: "season_pass_premium_track_title_10th_anniversary_2026" | "season_pass_premium_track_title_july";
		},
	];
}
