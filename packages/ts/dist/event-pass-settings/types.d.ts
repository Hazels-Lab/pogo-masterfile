...
export interface EventPassSettingsData {
	eventPassDisplaySettings: {
		...
		eventPassTitleKey: "event_pass_gofest2026_base_track_title" | "season_pass_base_track_title_july" | "season_pass_base_track_title_june";
		eventPassTrackUpgradeDescriptions: [
			{
				detailsLinkKey: "gofest2026_details_link" | "season_pass_details_link_july2026" | "season_pass_details_link_june2026";
				eventDurationKey: "event_pass_gofest2026_event_duration" | "season_pass_july2026_event_duration" | "season_pass_june2026_event_duration";
				eventPassTrackToUpgradeTo: "PREMIUM";
				passTrackUpgradeHeaderDescription:
					| "event_pass_gofest2026_track_upgrade_header_description"
					| "season_pass_july2026_track_upgrade_header_description"
					| "season_pass_june2026_track_upgrade_header_description";
				...
				upgradeDescriptionKey:
					| "event_pass_gofest2026_upgrade_description"
					| "season_pass_july2026_upgrade_description"
					| "season_pass_june2026_upgrade_description";
			},
		];
		headerIconUrl:
		...
		premiumRewardBannerMiddle: "item_incubator_timed_name" | "item_triple_stat_increase_name" | "today_view_pokecoins_section_title";
	...
	expirationTime: "2026-07-07T10:00:00" | "2026-07-12T23:59:59" | "2026-08-04T10:00:00";
	gracePeriodEndTime: "2026-07-09T10:00:00" | "2026-07-14T23:59:59" | "2026-08-06T10:00:00";
	maxTierLevel: number;
	pointsItemId: "ITEM_EVENT_PASS_POINT_GO_FEST_01" | "ITEM_EVENT_PASS_POINT_MONTHLY_01" | "ITEM_EVENT_PASS_POINT_MONTHLY_02";
	trackConditions: [
		{
			track: "FREE";
			trackTitleKey: "event_pass_gofest2026_base_track_title" | "season_pass_base_track_title_july" | "season_pass_base_track_title_june";
		},
		{
			badge: "BADGE_EVENT_0190" | "BADGE_EVENT_0191" | "BADGE_GOFEST_2026_EVENT_PASS_DELUXE";
			track: "PREMIUM";
			trackTitleKey: "event_pass_gofest2026_premium_track_title" | "season_pass_premium_track_title_july" | "season_pass_premium_track_title_june";
		},
	];
}
