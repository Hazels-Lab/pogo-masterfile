...
export interface EventPassSettingsData {
	...
	eventPassDisplaySettings: {
		eventPassTitleKey: "season_pass_base_track_title_aug" | "season_pass_base_track_title_summermarathon2026";
		eventPassTrackUpgradeDescriptions: [
			{
				detailsLinkKey: "season_pass_details_link_august2026" | "season_pass_details_link_summermarathon2026";
				eventDurationKey: "season_pass_august2026_event_duration" | "season_pass_summermarathon2026_event_duration";
				eventPassTrackToUpgradeTo: "PREMIUM";
				passTrackUpgradeHeaderDescription: "season_pass_august2026_track_upgrade_header_description" | "season_pass_premium_track_title_summermarathon2026";
				...
				trackUnlockSkuId: "pgorelease.august1_deluxe_event_pass_track_unlock" | "pgorelease.month3_deluxe_event_pass_track_unlock";
				upgradeDescriptionKey: "season_pass_august2026_upgrade_description" | "season_pass_summermarathon2026_upgrade_description";
			},
		];
	...
	expirationTime: "2026-08-10T20:00:00" | "2026-09-08T10:00:00";
	gracePeriodEndTime: "2026-08-12T20:00:00" | "2026-09-10T10:00:00";
	maxTierLevel: number;
	pointsItemId: "ITEM_EVENT_PASS_POINT_LIVE_OPS_09" | "ITEM_EVENT_PASS_POINT_MONTHLY_03";
	trackConditions: [
		{
			track: "FREE";
			trackTitleKey: "season_pass_base_track_title_aug" | "season_pass_base_track_title_summermarathon2026";
		},
		{
			badge: "BADGE_EVENT_0192" | "BADGE_EVENT_0227";
			track: "PREMIUM";
			trackTitleKey: "season_pass_premium_track_title_aug" | "season_pass_premium_track_title_summermarathon2026";
		},
	];
}
