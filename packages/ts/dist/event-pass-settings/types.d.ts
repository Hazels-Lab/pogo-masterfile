...
export interface EventPassSettingsData {
	...
	eventPassDisplaySettings: {
		eventPassTitleKey: "season_pass_base_track_title_horizons_fall_2026" | "season_pass_base_track_title_sep";
		eventPassTrackUpgradeDescriptions: [
			{
				detailsLinkKey: "season_pass_details_link_horizons_fall_2026" | "season_pass_details_link_sep2026";
				eventDurationKey: "season_pass_horizons_fall_2026_event_duration" | "season_pass_sep2026_event_duration";
				...
				trackUnlockSkuId: "pgorelease.month1_deluxe_event_pass_track_unlock" | "pgorelease.september2_2026_deluxe_event_pass_track_unlock";
				upgradeDescriptionKey: "season_pass_horizons_fall_2026_upgrade_description" | "season_pass_sep2026_upgrade_description";
			},
		];
		...
		premiumRewardBannerMiddle: "item_incubator_timed_name" | "item_paid_raid_ticket_name";
		sectionDisplayPriority: number;
	};
	expirationTime: "2026-09-22T20:00:00" | "2026-10-06T10:00:00";
	gracePeriodEndTime: "2026-09-24T20:00:00" | "2026-10-08T10:00:00";
	maxTierLevel: number;
	pointsItemId: "ITEM_EVENT_PASS_POINT_LIVE_OPS_02" | "ITEM_EVENT_PASS_POINT_MONTHLY_01";
	trackConditions: [
		{
			track: "FREE";
			trackTitleKey: "season_pass_base_track_title_horizons_fall_2026" | "season_pass_base_track_title_sep";
		},
		{
			badge: "BADGE_EVENT_0236" | "BADGE_EVENT_0242";
			track: "PREMIUM";
			trackTitleKey: "season_pass_premium_track_title_horizons_fall_2026" | "season_pass_premium_track_title_sep";
		},
	];
}
