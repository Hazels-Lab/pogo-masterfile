...
import type { EventPassSettings, EventPassSettingsData } from "./index";

export type EventPassSettingsApril2026Season = S<EventPassSettings<"EVENT_PASS_APRIL2026_SEASON", {
...
export type EventPassSettingsSteeledresolve2026Event = S<EventPassSettings<"EVENT_PASS_STEELEDRESOLVE2026_EVENT", {
