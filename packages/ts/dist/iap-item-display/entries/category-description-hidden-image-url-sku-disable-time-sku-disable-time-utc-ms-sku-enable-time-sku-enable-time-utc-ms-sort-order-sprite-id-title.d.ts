// Generated from Pokémon GO masterfile — group "iapItemDisplay", split "category-description-hidden-image-url-sku-disable-time-sku-disable-time-utc-ms-sku-enable-time-sku-enable-time-utc-ms-sort-order-sprite-id-title", 8 entries.

import type { S } from "../../_utils";
import type { IapItemDisplay, IapItemDisplayData } from "../types";

export type IapItemDisplayBattlepassticket1 = S<IapItemDisplay<"battlepassticket.1", {
...
export type IapItemDisplayGeneral2Ticket8 = S<IapItemDisplay<"general2.ticket.8", {
...
export type IapItemDisplayGeneral2Ticket8Giftable = S<IapItemDisplay<"general2.ticket.8.giftable", {
    category: "IAP_CATEGORY_GLOBAL_EVENT_TICKET";
    description: "item_event_ticket_gray_details_FinalJustice2025";
    hidden: true;
    imageUrl: "https://pgorelease-assets.nianticstatic.com/GameDesignAssets%2FPGO-MCS_Shiny_Keldeo_KeyArt_v1-1024x576-nologo.jpg";
...
export type IapItemDisplayPgoreleaseCitysafariticket01 = S<IapItemDisplay<"pgorelease.citysafariticket0.1", {
    category: "IAP_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type IapItemDisplayPgoreleaseCitysafariticket11 = S<IapItemDisplay<"pgorelease.citysafariticket1.1", {
    category: "IAP_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type IapItemDisplayPgoreleaseCitysafariticket21 = S<IapItemDisplay<"pgorelease.citysafariticket2.1", {
    category: "IAP_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type IapItemDisplayPgoreleaseGeneral2Ticket8 = S<IapItemDisplay<"pgorelease.general2.ticket.8", {
    category: "IAP_CATEGORY_GLOBAL_EVENT_TICKET";
    description: "item_event_ticket_gray_details_FinalJustice2025";
    hidden: true;
    imageUrl: "https://pgorelease-assets.nianticstatic.com/GameDesignAssets%2FPGO-MCS_Shiny_Keldeo_KeyArt_v1-1024x576-nologo.jpg";
...
export type IapItemDisplayPgoreleaseGeneral2Ticket8Giftable = S<IapItemDisplay<"pgorelease.general2.ticket.8.giftable", {
    category: "IAP_CATEGORY_GLOBAL_EVENT_TICKET";
    description: "item_event_ticket_gray_details_FinalJustice2025";
    hidden: true;
    imageUrl: "https://pgorelease-assets.nianticstatic.com/GameDesignAssets%2FPGO-MCS_Shiny_Keldeo_KeyArt_v1-1024x576-nologo.jpg";
...
export type IapItemDisplayCategoryDescriptionHiddenImageUrlSkuDisableTimeSkuDisableTimeUtcMsSkuEnableTimeSkuEnableTimeUtcMsSortOrderSpriteIdTitleMasterfileEntry = IapItemDisplayBattlepassticket1 | IapItemDisplayGeneral2Ticket8 | IapItemDisplayGeneral2Ticket8Giftable | IapItemDisplayPgoreleaseCitysafariticket01 | IapItemDisplayPgoreleaseCitysafariticket11 | IapItemDisplayPgoreleaseCitysafariticket21 | IapItemDisplayPgoreleaseGeneral2Ticket8 | IapItemDisplayPgoreleaseGeneral2Ticket8Giftable;
