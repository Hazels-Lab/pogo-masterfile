...
export type IapItemDisplayEventPassApril3EventStoreRedirect = S<IapItemDisplay<"EVENT_PASS_APRIL3_EVENT_STORE_REDIRECT", {
...
export type IapItemDisplayEventPassMonth2SeasonStoreRedirect = S<IapItemDisplay<"EVENT_PASS_MONTH2_SEASON_STORE_REDIRECT", {
    category: "IAP_CATEGORY_GLOBAL_EVENT_TICKET";
    description: "gotour_2025_deluxe_event_pass_track_unlock_description";
...
export type IapItemDisplayCategoryDescriptionImageUrlSkuDisableTimeSkuDisableTimeUtcMsSkuEnableTimeSkuEnableTimeUtcMsSortOrderTitleMasterfileEntry = IapItemDisplayEventPassApril3EventStoreRedirect | IapItemDisplayEventPassMonth2SeasonStoreRedirect;
