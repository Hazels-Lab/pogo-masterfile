...
export interface ItemSettingsData {
    ...
    globalEventTicket?: {
        ...
        clientEventEndTimeUtcMs: "1728424800000" | "1728943200000" | "1730844000000" | "1732472100000" | "1750636799000" | "1764532800000" | "1769976000000" | "1770494400000" | "1771790400000" | "1772409599000" | "1774112400000" | "1774717200000" | "1775210400000" | "1775322000000" | "1776531600000" | "1777136400000" | "1777741200000" | "1778346000000";
        clientEventStartTimeUtcMs: "1696845600000" | "1697364000000" | "1699264800000" | "1732356000000" | "1750377600000" | "1764064800000" | "1764669600000" | "1769508000000" | "1770458400000" | "1772236800000" | "1772542800000" | "1774101600000" | "1774706400000" | "1775311200000" | "1776510000000" | "1777125600000" | "1777730400000" | "1778335200000";
        ...
        iconRewards?: Array<{
            ...
            item?: {
                amount?: number;
                item: "ITEM_FREE_RAID_TICKET" | "ITEM_INCENSE_ORDINARY" | "ITEM_INCUBATOR_BASIC" | "ITEM_INCUBATOR_SUPER" | "ITEM_MASTER_BALL" | "ITEM_MAX_BOOST" | "ITEM_STAR_PIECE" | "ITEM_XL_RARE_CANDY";
            };
            ...
            pokemonEncounter?: {
                pokemonDisplay?: {
                    form: "CLAMPERL_NORMAL" | "DIANCIE_NORMAL" | "DIGLETT_NORMAL" | "FEEBAS_NORMAL" | "GLIMMET_NORMAL" | "KELDEO_ORDINARY" | "LATIAS_NORMAL" | "LATIOS_NORMAL" | "LOTAD_NORMAL" | "OINKOLOGNE_NORMAL" | "ROCKRUFF_NORMAL" | "YUNGOOS_NORMAL";
                    shiny?: boolean;
                };
                pokemonId: "CLAMPERL" | "DIANCIE" | "DIGLETT" | "FEEBAS" | "GLIMMET" | "KELDEO" | "LATIAS" | "LATIOS" | "LOTAD" | "OINKOLOGNE" | "ROCKRUFF" | "YAMPER" | "YUNGOOS";
            };
            stardust?: number;
            "type": "AVATAR_CLOTHING" | "CANDY" | "EXPERIENCE" | "ITEM" | "POKEMON_ENCOUNTER" | "STARDUST";
        }>;
        itemBagDescriptionKey: "item_battle_pass_ticket_desc" | "item_event_ticket_02_desc_CATCH_MASTERY_ORICORIO" | "item_event_ticket_05_details_GMAX_PIKACHU_MAX_BATTLE" | "item_event_ticket_06_details_REPLAY_GO_BIGGER" | "item_event_ticket_07_desc_masterball25" | "item_event_ticket_07_details_masterball25" | "ITEM_EVENT_TICKET_09_desc_fashionRaidDay26" | "ITEM_EVENT_TICKET_09_details_fashionRaidDay26" | "item_event_ticket_evergreen_desc_GOWA2024GSBEA" | "item_event_ticket_evergreen_desc_IntoTDepths26" | "item_event_ticket_evergreen_desc_Riolu0426" | "item_event_ticket_evergreen_details_IntoTDepths26" | "item_event_ticket_evergreen_details_PawPrint_20250620" | "item_event_ticket_evergreen_details_Riolu0426" | "item_event_ticket_gray_desc_FinalJustice2025" | "item_event_ticket_gray_details_ENTEI_SHADOW_RAID_DAY" | "item_event_ticket_pink_desc_CD_Lechonk26" | "item_event_ticket_pink_desc_WaterRRD26" | "item_global_event_ticket_details_GOTour2026" | "item_ticket_city_safari_00_desc" | "item_ticket_city_safari_01_desc" | "item_ticket_city_safari_02_desc";
        textRewardsKey?: "text_rewards_key_CATCH_MASTERY_ORICORIO" | "text_rewards_key_CD_Lechonk26" | "text_rewards_key_ENTEI_SHADOW_RAID_DAY" | "text_rewards_key_fashionRaidDay26" | "text_rewards_key_FinalJustice2025" | "text_rewards_key_GMAX_PIKACHU_MAX_BATTLE" | "text_rewards_key_GOTour2026" | "text_rewards_key_IntoTDepths26" | "text_rewards_key_masterball25" | "text_rewards_key_PawPrint_20250620" | "text_rewards_key_REPLAY_GO_BIGGER" | "text_rewards_key_Riolu0426" | "text_rewards_key_WaterRRD26";
        ticketItem?: "ITEM_EVENT_TICKET_02" | "ITEM_EVENT_TICKET_03" | "ITEM_EVENT_TICKET_04" | "ITEM_EVENT_TICKET_05" | "ITEM_EVENT_TICKET_06" | "ITEM_EVENT_TICKET_07" | "ITEM_EVENT_TICKET_08" | "ITEM_EVENT_TICKET_09" | "ITEM_EVENT_TICKET_10" | "ITEM_EVENT_TICKET_GRAY" | "ITEM_EVENT_TICKET_PINK" | "ITEM_EVERGREEN_TICKET" | "ITEM_GLOBAL_EVENT_TICKET";
