...
export type ItemSettingsItemFreeRaidTicket = S<ItemSettings<"ITEM_FREE_RAID_TICKET", {
    category: "ITEM_CATEGORY_RAID_TICKET";
    dropTrainerLevel: 100;
    itemType: "ITEM_TYPE_RAID_TICKET";
}>>;
export type ItemSettingsItemPaidRaidTicket = S<ItemSettings<"ITEM_PAID_RAID_TICKET", {
    category: "ITEM_CATEGORY_RAID_TICKET";
    dropTrainerLevel: 1;
    itemType: "ITEM_TYPE_RAID_TICKET";
}>>;
export type ItemSettingsItemRemoteRaidTicket = S<ItemSettings<"ITEM_REMOTE_RAID_TICKET", {
    category: "ITEM_CATEGORY_RAID_TICKET";
    dropTrainerLevel: 5;
    itemType: "ITEM_TYPE_RAID_TICKET";
}>>;
