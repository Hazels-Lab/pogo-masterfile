...
export type ItemSettingsItemBattlePassTicket = S<ItemSettings<"ITEM_BATTLE_PASS_TICKET", {
...
export type ItemSettingsItemEventTicket02 = S<ItemSettings<"ITEM_EVENT_TICKET_02", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemEventTicket02ToGift = S<ItemSettings<"ITEM_EVENT_TICKET_02_TO_GIFT", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
    descriptionOverride: "item_event_ticket_02_details_CATCH_MASTERY_ORICORIO";
    globalEventTicket: {
        clientEventEndTimeUtcMs: "1770494400000";
...
export type ItemSettingsItemEventTicket03 = S<ItemSettings<"ITEM_EVENT_TICKET_03", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemEventTicket03ToGift = S<ItemSettings<"ITEM_EVENT_TICKET_03_TO_GIFT", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
    descriptionOverride: "item_event_ticket_pink_details_CD_Lechonk26";
    globalEventTicket: {
        clientEventEndTimeUtcMs: "1778346000000";
...
export type ItemSettingsItemEventTicket04 = S<ItemSettings<"ITEM_EVENT_TICKET_04", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemEventTicket04ToGift = S<ItemSettings<"ITEM_EVENT_TICKET_04_TO_GIFT", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
    descriptionOverride: "item_event_ticket_pink_details_WaterRRD26";
    globalEventTicket: {
        clientEventEndTimeUtcMs: "1774112400000";
...
export type ItemSettingsItemEventTicket05 = S<ItemSettings<"ITEM_EVENT_TICKET_05", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemEventTicket05ToGift = S<ItemSettings<"ITEM_EVENT_TICKET_05_TO_GIFT", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
    descriptionOverride: "item_event_ticket_05_desc_GMAX_PIKACHU_MAX_BATTLE";
    globalEventTicket: {
        backgroundImageUrl: "https://pgorelease-assets.nianticstatic.com/GameDesignAssets%2Fpgo-gmax-pikachu-2026-nologo.jpg";
...
export type ItemSettingsItemEventTicket06 = S<ItemSettings<"ITEM_EVENT_TICKET_06", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemEventTicket06ToGift = S<ItemSettings<"ITEM_EVENT_TICKET_06_TO_GIFT", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
    descriptionOverride: "item_event_ticket_06_desc_REPLAY_GO_BIGGER";
    globalEventTicket: {
        clientEventEndTimeUtcMs: "1777136400000";
...
export type ItemSettingsItemEventTicket07 = S<ItemSettings<"ITEM_EVENT_TICKET_07", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemEventTicket07ToGift = S<ItemSettings<"ITEM_EVENT_TICKET_07_TO_GIFT", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemEventTicket08 = S<ItemSettings<"ITEM_EVENT_TICKET_08", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemEventTicket08ToGift = S<ItemSettings<"ITEM_EVENT_TICKET_08_TO_GIFT", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
    descriptionOverride: "item_event_ticket_gray_desc_FinalJustice2025";
    globalEventTicket: {
        clientEventEndTimeUtcMs: "1764532800000";
...
export type ItemSettingsItemEventTicket09 = S<ItemSettings<"ITEM_EVENT_TICKET_09", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemEventTicket09ToGift = S<ItemSettings<"ITEM_EVENT_TICKET_09_TO_GIFT", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemEventTicket10 = S<ItemSettings<"ITEM_EVENT_TICKET_10", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemEventTicket10ToGift = S<ItemSettings<"ITEM_EVENT_TICKET_10_TO_GIFT", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
    descriptionOverride: "item_global_event_ticket_details_GOTour2026";
    globalEventTicket: {
        clientEventEndTimeUtcMs: "1772409599000";
...
export type ItemSettingsItemEventTicketGray = S<ItemSettings<"ITEM_EVENT_TICKET_GRAY", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemEventTicketGrayToGift = S<ItemSettings<"ITEM_EVENT_TICKET_GRAY_TO_GIFT", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
    descriptionOverride: "item_event_ticket_06_desc_ENTEI_SHADOW_RAID_DAY";
    globalEventTicket: {
        backgroundImageUrl: "https://storage.googleapis.com/prod-public-images/1054x512.jpg";
...
export type ItemSettingsItemEventTicketPink = S<ItemSettings<"ITEM_EVENT_TICKET_PINK", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemEventTicketPinkToGift = S<ItemSettings<"ITEM_EVENT_TICKET_PINK_TO_GIFT", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
    descriptionOverride: "item_event_ticket_evergreen_desc_PawPrint_20250620";
    globalEventTicket: {
        clientEventEndTimeUtcMs: "1750636799000";
...
export type ItemSettingsItemEvergreenTicket = S<ItemSettings<"ITEM_EVERGREEN_TICKET", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemEvergreenTicketToGift = S<ItemSettings<"ITEM_EVERGREEN_TICKET_TO_GIFT", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemGlobalEventTicket = S<ItemSettings<"ITEM_GLOBAL_EVENT_TICKET", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemGlobalEventTicketToGift = S<ItemSettings<"ITEM_GLOBAL_EVENT_TICKET_TO_GIFT", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsItemTicketCitySafari00 = S<ItemSettings<"ITEM_TICKET_CITY_SAFARI_00", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
    globalEventTicket: {
...
export type ItemSettingsItemTicketCitySafari01 = S<ItemSettings<"ITEM_TICKET_CITY_SAFARI_01", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
    globalEventTicket: {
...
export type ItemSettingsItemTicketCitySafari02 = S<ItemSettings<"ITEM_TICKET_CITY_SAFARI_02", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
    globalEventTicket: {
...
export type ItemSettingsItemTicketCitySafari04 = S<ItemSettings<"ITEM_TICKET_CITY_SAFARI_04", {
    category: "ITEM_CATEGORY_GLOBAL_EVENT_TICKET";
...
export type ItemSettingsGlobalEventTicketMasterfileEntry = ItemSettingsItemBattlePassTicket | ItemSettingsItemEventTicket02 | ItemSettingsItemEventTicket02ToGift | ItemSettingsItemEventTicket03 | ItemSettingsItemEventTicket03ToGift | ItemSettingsItemEventTicket04 | ItemSettingsItemEventTicket04ToGift | ItemSettingsItemEventTicket05 | ItemSettingsItemEventTicket05ToGift | ItemSettingsItemEventTicket06 | ItemSettingsItemEventTicket06ToGift | ItemSettingsItemEventTicket07 | ItemSettingsItemEventTicket07ToGift | ItemSettingsItemEventTicket08 | ItemSettingsItemEventTicket08ToGift | ItemSettingsItemEventTicket09 | ItemSettingsItemEventTicket09ToGift | ItemSettingsItemEventTicket10 | ItemSettingsItemEventTicket10ToGift | ItemSettingsItemEventTicketGray | ItemSettingsItemEventTicketGrayToGift | ItemSettingsItemEventTicketPink | ItemSettingsItemEventTicketPinkToGift | ItemSettingsItemEvergreenTicket | ItemSettingsItemEvergreenTicketToGift | ItemSettingsItemGlobalEventTicket | ItemSettingsItemGlobalEventTicketToGift | ItemSettingsItemTicketCitySafari00 | ItemSettingsItemTicketCitySafari01 | ItemSettingsItemTicketCitySafari02 | ItemSettingsItemTicketCitySafari04;
