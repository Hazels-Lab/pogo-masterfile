...
export type MasterfileEntryType = AvatarCustomization | AvatarGroupOrderSettings | AvatarItemDisplay | BadgeSettings | BreadMoveLevelSettings | BuddyActivityCategorySettings | BuddyEmotionLevelSettings | BuddyLevelSettings | ClientQuestTemplate | CodeGateProto | CombatLeague | CombatMove | CombatNpcPersonality | CombatNpcTrainer | CombatRankingProtoSettings | CombatType | EventPassSettings | EventPassTierSettings | EvolutionChainDisplaySettings | EvolutionQuestTemplate | FeatureGate | FormSettings | FortPowerUpLevelSettings | FriendshipMilestoneSettings | GenderSettings | IapCategoryDisplay | IapItemDisplay | InvasionNpcDisplaySettings | ItemExpirationSettings | ItemSettings | LanguageSettings | LevelUpRewards | LimitedPurchaseSkuSettings | LocationCardSettings | MegaEvoLevelSettings | MoveSequenceSettings | MoveSettings | NonCombatMoveSettings | PartyPlayGeneralSettings | PhotoSetsSettingsProto | PokemonExtendedSettings | PokemonFamily | PokemonHomeEnergyCosts | PokemonHomeFormReversions | PokemonScaleSettings | PokemonSettings | PokemonUpgrades | PokestopInvasionAvailabilitySettings | QuestSettings | RecommendedSearchSettings | RollBack | SettingsOverrideRule | Singletons | StickerMetadata | TappableSettings | TemporaryEvolutionSettings | TypeEffective | VsSeekerLoot | VsSeekerPokemonRewards | WeatherAffinities;

export type MasterfileType = AvatarCustomizationType | AvatarGroupOrderSettingsType | AvatarItemDisplayType | BadgeSettingsType | BreadMoveLevelSettingsType | BuddyActivityCategorySettingsType | BuddyEmotionLevelSettingsType | BuddyLevelSettingsType | ClientQuestTemplateType | CodeGateProtoType | CombatLeagueType | CombatMoveType | CombatNpcPersonalityType | CombatNpcTrainerType | CombatRankingProtoSettingsType | CombatTypeType | EventPassSettingsType | EventPassTierSettingsType | EvolutionChainDisplaySettingsType | EvolutionQuestTemplateType | FeatureGateType | FormSettingsType | FortPowerUpLevelSettingsType | FriendshipMilestoneSettingsType | GenderSettingsType | IapCategoryDisplayType | IapItemDisplayType | InvasionNpcDisplaySettingsType | ItemExpirationSettingsType | ItemSettingsType | LanguageSettingsType | LevelUpRewardsType | LimitedPurchaseSkuSettingsType | LocationCardSettingsType | MegaEvoLevelSettingsType | MoveSequenceSettingsType | MoveSettingsType | NonCombatMoveSettingsType | PartyPlayGeneralSettingsType | PhotoSetsSettingsProtoType | PokemonExtendedSettingsType | PokemonFamilyType | PokemonHomeEnergyCostsType | PokemonHomeFormReversionsType | PokemonScaleSettingsType | PokemonSettingsType | PokemonUpgradesType | PokestopInvasionAvailabilitySettingsType | QuestSettingsType | RecommendedSearchSettingsType | RollBackType | SettingsOverrideRuleType | SingletonsType | StickerMetadataType | TappableSettingsType | TemporaryEvolutionSettingsType | TypeEffectiveType | VsSeekerLootType | VsSeekerPokemonRewardsType | WeatherAffinitiesType;
