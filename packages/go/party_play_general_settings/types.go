...
type PartyPlayGeneralSettingsPartySchedulingSettings struct {
	...
	RecurringChallengeSchedule *PartyPlayGeneralSettingsRecurringChallengeSchedule `json:"recurringChallengeSchedule,omitempty"`
}
...
type PartyPlayGeneralSettings struct {
	...
	PartySchedulingSettings            PartyPlayGeneralSettingsPartySchedulingSettings `json:"partySchedulingSettings"`
