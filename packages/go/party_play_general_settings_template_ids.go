...
type PartyPlayGeneralSettingsTemplateID string

const (
	PartyPlayGeneralSettingsTemplateIDPartyPlayGeneralSettings       PartyPlayGeneralSettingsTemplateID = "PARTY_PLAY_GENERAL_SETTINGS"
