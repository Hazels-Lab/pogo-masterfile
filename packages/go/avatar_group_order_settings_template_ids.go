...
type AvatarGroupOrderSettingsTemplateID string

const (
	AvatarGroupOrderSettingsTemplateIDAvatarGroupOrderSettings AvatarGroupOrderSettingsTemplateID = "AVATAR_GROUP_ORDER_SETTINGS"
