...
export interface ItemSettingsData<T extends string> {
	...
	itemSettings: {
		...
		itemId: "FUSION_RESOURCE_BLACK_KYUREM" | "FUSION_RESOURCE_DAWNWINGS_NECROZMA" | "FUSION_RESOURCE_DUSKMANE_NECROZMA" | "FUSION_RESOURCE_WHITE_KYUREM" | "ITEM_BATTLE_PASS_TICKET" | "ITEM_BEANS" | "ITEM_BEAST_BALL" | "ITEM_BLUK_BERRY" | "ITEM_BREAKFAST" | "ITEM_DRAGON_SCALE" | "ITEM_ENHANCED_CURRENCY" | "ITEM_ENHANCED_CURRENCY_HOLDER" | "ITEM_EVENT_PASS_POINT_GO_FEST_01" | "ITEM_EVENT_PASS_POINT_GO_FEST_02" | "ITEM_EVENT_PASS_POINT_GO_TOUR_01" | "ITEM_EVENT_PASS_POINT_GO_TOUR_02" | "ITEM_EVENT_PASS_POINT_GO_WILD_AREA_01" | "ITEM_EVENT_PASS_POINT_LIVE_OPS_01" | "ITEM_EVENT_PASS_POINT_LIVE_OPS_02" | "ITEM_EVENT_PASS_POINT_LIVE_OPS_03" | "ITEM_EVENT_PASS_POINT_LIVE_OPS_04" | "ITEM_EVENT_PASS_POINT_LIVE_OPS_05" | "ITEM_EVENT_PASS_POINT_LIVE_OPS_06" | "ITEM_EVENT_PASS_POINT_LIVE_OPS_07" | "ITEM_EVENT_PASS_POINT_LIVE_OPS_08" | "ITEM_EVENT_PASS_POINT_MONTHLY_01" | "ITEM_EVENT_PASS_POINT_MONTHLY_02" | "ITEM_EVENT_PASS_POINT_MONTHLY_03" | "ITEM_EVENT_TICKET_02" | "ITEM_EVENT_TICKET_02_TO_GIFT" | "ITEM_EVENT_TICKET_03" | "ITEM_EVENT_TICKET_03_TO_GIFT" | "ITEM_EVENT_TICKET_04" | "ITEM_EVENT_TICKET_04_TO_GIFT" | "ITEM_EVENT_TICKET_05" | "ITEM_EVENT_TICKET_05_TO_GIFT" | "ITEM_EVENT_TICKET_06" | "ITEM_EVENT_TICKET_07" | "ITEM_EVENT_TICKET_07_TO_GIFT" | "ITEM_EVENT_TICKET_08" | "ITEM_EVENT_TICKET_08_TO_GIFT" | "ITEM_EVENT_TICKET_09" | "ITEM_EVENT_TICKET_09_TO_GIFT" | "ITEM_EVENT_TICKET_10" | "ITEM_EVENT_TICKET_10_TO_GIFT" | "ITEM_EVENT_TICKET_GRAY" | "ITEM_EVENT_TICKET_PINK" | "ITEM_EVENT_TICKET_PINK_TO_GIFT" | "ITEM_EVERGREEN_TICKET" | "ITEM_EVERGREEN_TICKET_TO_GIFT" | "ITEM_FREE_RAID_TICKET" | "ITEM_FRIEND_GIFT_BOX" | "ITEM_GEN4_EVOLUTION_STONE" | "ITEM_GEN5_EVOLUTION_STONE" | "ITEM_GIOVANNI_MAP" | "ITEM_GLOBAL_EVENT_TICKET" | "ITEM_GLOBAL_EVENT_TICKET_TO_GIFT" | "ITEM_GOLDEN_PINAP_BERRY" | "ITEM_GOLDEN_RAZZ_BERRY" | "ITEM_GREAT_BALL" | "ITEM_HYPER_POTION" | "ITEM_INCENSE_BELUGA_BOX" | "ITEM_INCENSE_DAILY_ADVENTURE" | "ITEM_INCENSE_DAY_BONUS" | "ITEM_INCENSE_NIGHT_BONUS" | "ITEM_INCENSE_ORDINARY" | "ITEM_INCENSE_SPARKLY" | "ITEM_INCUBATOR_BASIC" | "ITEM_INCUBATOR_BASIC_UNLIMITED" | "ITEM_INCUBATOR_SPECIAL" | "ITEM_INCUBATOR_SUPER" | "ITEM_INCUBATOR_TIMED" | "ITEM_ITEM_STORAGE_UPGRADE" | "ITEM_KINGS_ROCK" | "ITEM_LEADER_MAP" | "ITEM_LEADER_MAP_FRAGMENT" | "ITEM_LUCKY_EGG" | "ITEM_LUCKY_FRIEND_APPLICATOR" | "ITEM_MASTER_BALL" | "ITEM_MAX_BOOST" | "ITEM_MAX_POTION" | "ITEM_MAX_REVIVE" | "ITEM_METAL_COAT" | "ITEM_MOVE_REROLL_ELITE_FAST_ATTACK" | "ITEM_MOVE_REROLL_ELITE_SPECIAL_ATTACK" | "ITEM_MOVE_REROLL_FAST_ATTACK" | "ITEM_MOVE_REROLL_OTHER_SPECIAL_ATTACK_A" | "ITEM_MOVE_REROLL_SPECIAL_ATTACK" | "ITEM_MP" | "ITEM_MP_REPLENISH" | "ITEM_NANAB_BERRY" | "ITEM_OTHER_EVOLUTION_STONE_A" | "ITEM_OTHER_EVOLUTION_STONE_MAPLE_A" | "ITEM_OTHER_EVOLUTION_STONE_MAPLE_B" | "ITEM_OTHER_EVOLUTION_STONE_MAPLE_C" | "ITEM_PAID_RAID_TICKET" | "ITEM_PINAP_BERRY" | "ITEM_POFFIN" | "ITEM_POKE_BALL" | "ITEM_POKEMON_STORAGE_UPGRADE" | "ITEM_POSTCARD_INVENTORY" | "ITEM_POSTCARD_STORAGE_UPGRADE" | "ITEM_POTION" | "ITEM_PREMIER_BALL" | "ITEM_RARE_CANDY" | "ITEM_RAZZ_BERRY" | "ITEM_REMOTE_RAID_TICKET" | "ITEM_RESOURCE_CROWNED_ZACIAN" | "ITEM_RESOURCE_CROWNED_ZAMAZENTA" | "ITEM_REVIVE" | "ITEM_ROUTE_MAKER" | "ITEM_SHADOW_GEM" | "ITEM_SHADOW_GEM_FRAGMENT" | "ITEM_SINGLE_STAT_INCREASE" | "ITEM_SOFT_SFIDA" | "ITEM_SPECIAL_CAMERA" | "ITEM_STAR_PIECE" | "ITEM_STICKER_INVENTORY" | "ITEM_SUN_STONE" | "ITEM_SUPER_POTION" | "ITEM_TEAM_CHANGE" | "ITEM_TICKET_CITY_SAFARI_00" | "ITEM_TICKET_CITY_SAFARI_01" | "ITEM_TICKET_CITY_SAFARI_02" | "ITEM_TICKET_CITY_SAFARI_04" | "ITEM_TRIPLE_STAT_INCREASE" | "ITEM_TROY_DISK" | "ITEM_TROY_DISK_GLACIAL" | "ITEM_TROY_DISK_MAGNETIC" | "ITEM_TROY_DISK_MOSSY" | "ITEM_TROY_DISK_RAINY" | "ITEM_TROY_DISK_SPARKLY" | "ITEM_ULTRA_BALL" | "ITEM_UP_GRADE" | "ITEM_WEPAR_BERRY" | "ITEM_WILD_BALL" | "ITEM_WILD_BALL_PREMIER" | "ITEM_X_ATTACK" | "ITEM_X_DEFENSE" | "ITEM_X_MIRACLE" | "ITEM_XL_RARE_CANDY";
