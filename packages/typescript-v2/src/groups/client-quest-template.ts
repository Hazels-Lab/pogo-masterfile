export interface ClientQuestTemplate<T extends string> {
	templateId: T;
	data: ClientQuestTemplateData<T>;
}

export interface ClientQuestTemplateData<T extends string> {
	templateId: T;
	clientQuestTemplate: {
		quest: {
			difficulty?: "EASY";
			goal?: {
				condition?: Array<
					{
						"type": "WITH_BADGE_TYPE" | "WITH_COMBAT_TYPE" | "WITH_DAYS_IN_A_ROW" | "WITH_DISTANCE" | "WITH_INVASION_CHARACTER" | "WITH_LEGENDARY_POKEMON" | "WITH_LUCKY_POKEMON" | "WITH_POKEMON_LEVEL" | "WITH_QUEST_CONTEXT" | "WITH_SINGLE_DAY" | "WITH_SUPER_EFFECTIVE_CHARGE" | "WITH_THROW_TYPE" | "WITH_WIN_BATTLE_STATUS" | "WITH_WIN_RAID_STATUS";
						withBadgeType?: {
							badgeRank: 4;
							badgeTypesToExclude: [
				...
				>;
				target: 3 | 7 | 10 | 15 | 20 | 25 | 30 | 34 | 38 | 41 | 44 | 47 | 50 | 75 | 80 | 100 | 150 | 200 | 250 | 300 | 400 | 500 | 999 | 1000000;
			};
			multiPart?: {
				subQuests: [
					{
			...
			questRewards: Array<
				{
					...
					levelCap?: 71 | 72 | 73 | 74 | 75 | 76 | 77 | 78 | 79 | 80;
					pokemonEncounter?: {
						pokemonDisplay: {
