...
export interface FeatureGateData<TemplateID extends string> {
	...
	featureGate: {
		...
		subFeatureGateList?: Array<
			{
				name: FeatureGateSubFeatureGateListName;
				rolloutPercentage: 100;
				status: FeatureGateSubFeatureGateListStatus;
			}
		>;
	};
}

export type FeatureGateStatus = 1 | 24 | 29825861 | 41414141 | 87970808 | 216426293 | 1827323905;

export type FeatureGateSubFeatureGateListName = "MEGA_2026_FTUE_SUB_FEATURE_GATE" | "MEGA_CP_BOOST_ENABLED_SUB_FEATURE_GATE" | "MEGA_EVOLVE_BUTTON_SUB_FEATURE_GATE" | "MEGA_HUD_SUB_FEATURE_GATE" | "MEGA_HUD_TIMER_SUB_FEATURE_GATE" | "MEGA_LEVEL_4_ENABLED_SUB_FEATURE_GATE" | "MEGA_LEVELS_TUTORIAL_SUB_FEATURE_GATE" | "PVP" | "REMOTE_NC_HELP_TEXT_SUB_FEATURE_GATE";

export type FeatureGateSubFeatureGateListStatus = 2 | 222 | 292744512 | 311989544 | 368387608 | 382901475 | 466713653 | 817843414 | 991283745;
