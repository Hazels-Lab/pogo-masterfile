...
impl<'de> Deserialize<'de> for MasterfileEntry {
		...
		D: serde::Deserializer<'de>,
	{
		...
		let result: serde_json::Result<Self> = if let Some(disc) = discriminator.as_deref() {
			match disc {
				"pokemonExtendedSettings" => serde_json::from_value(value).map(Self::PokemonExtendedSettings),
				...
				"avatarCustomization" => serde_json::from_value(value).map(Self::AvatarCustomization),
				...
				"eventPassTierSettings" => serde_json::from_value(value).map(Self::EventPassTierSettings),
				...
				"moveSequenceSettings" => serde_json::from_value(value).map(Self::MoveSequenceSettings),
				"combatMove" => serde_json::from_value(value).map(Self::CombatMove),
				"settingsOverrideRule" => serde_json::from_value(value).map(Self::SettingsOverrideRule),
				"locationCardSettings" => serde_json::from_value(value).map(Self::LocationCardSettings),
				...
				"megaEvoLevelSettings" => serde_json::from_value(value).map(Self::MegaEvoLevelSettings),
				"levelUpRewards" => serde_json::from_value(value).map(Self::LevelUpRewards),
				"evolutionChainDisplaySettings" => serde_json::from_value(value).map(Self::EvolutionChainDisplaySettings),
				"invasionNpcDisplaySettings" => serde_json::from_value(value).map(Self::InvasionNpcDisplaySettings),
				"clientQuestTemplate" => serde_json::from_value(value).map(Self::ClientQuestTemplate),
				"temporaryEvolutionSettings" => serde_json::from_value(value).map(Self::TemporaryEvolutionSettings),
				"vsSeekerLoot" => serde_json::from_value(value).map(Self::VsSeekerLoot),
				"photoSetsSettingsProto" => serde_json::from_value(value).map(Self::PhotoSetsSettingsProto),
				"evolutionQuestTemplate" => serde_json::from_value(value).map(Self::EvolutionQuestTemplate),
				"limitedPurchaseSkuSettings" => serde_json::from_value(value).map(Self::LimitedPurchaseSkuSettings),
				"itemExpirationSettings" => serde_json::from_value(value).map(Self::ItemExpirationSettings),
				"combatRankingProtoSettings" => serde_json::from_value(value).map(Self::CombatRankingProtoSettings),
				...
				"recommendedSearchSettings" => serde_json::from_value(value).map(Self::RecommendedSearchSettings),
				"combatNpcTrainer" => serde_json::from_value(value).map(Self::CombatNpcTrainer),
				"nonCombatMoveSettings" => serde_json::from_value(value).map(Self::NonCombatMoveSettings),
				"buddyActivityCategorySettings" => serde_json::from_value(value).map(Self::BuddyActivityCategorySettings),
				"breadMoveLevelSettings" => serde_json::from_value(value).map(Self::BreadMoveLevelSettings),
				"buddyEmotionLevelSettings" => serde_json::from_value(value).map(Self::BuddyEmotionLevelSettings),
				"pokemonHomeFormReversions" => serde_json::from_value(value).map(Self::PokemonHomeFormReversions),
				"pokestopInvasionAvailabilitySettings" => serde_json::from_value(value).map(Self::PokestopInvasionAvailabilitySettings),
				"weatherAffinities" => serde_json::from_value(value).map(Self::WeatherAffinities),
				"friendshipMilestoneSettings" => serde_json::from_value(value).map(Self::FriendshipMilestoneSettings),
				"pokemonScaleSettings" => serde_json::from_value(value).map(Self::PokemonScaleSettings),
				...
				"fortPowerUpLevelSettings" => serde_json::from_value(value).map(Self::FortPowerUpLevelSettings),
				"pokemonHomeEnergyCosts" => serde_json::from_value(value).map(Self::PokemonHomeEnergyCosts),
				"combatNpcPersonality" => serde_json::from_value(value).map(Self::CombatNpcPersonality),
				...
				"avatarGroupOrderSettings" => serde_json::from_value(value).map(Self::AvatarGroupOrderSettings),
				"eventPassSettings" => serde_json::from_value(value).map(Self::EventPassSettings),
				"partyPlayGeneralSettings" => serde_json::from_value(value).map(Self::PartyPlayGeneralSettings),
				"pokemonUpgrades" => serde_json::from_value(value).map(Self::PokemonUpgrades),
				"vsSeekerPokemonRewards" => serde_json::from_value(value).map(Self::VsSeekerPokemonRewards),
				"accessibilitySettings" => serde_json::from_value(value).map(Self::AccessibilitySettings),
				"additiveSceneSettings" => serde_json::from_value(value).map(Self::AdditiveSceneSettings),
				"addressablePokemonSettings" => serde_json::from_value(value).map(Self::AddressablePokemonSettings),
				"addressBookImportSettings" => serde_json::from_value(value).map(Self::AddressBookImportSettings),
				"advancedSettings" => serde_json::from_value(value).map(Self::AdvancedSettings),
				"arPhotoFeatureFlags" => serde_json::from_value(value).map(Self::ArPhotoFeatureFlags),
				"arTelemetrySettings" => serde_json::from_value(value).map(Self::ArTelemetrySettings),
				...
				"avatarStoreFooterFlags" => serde_json::from_value(value).map(Self::AvatarStoreFooterFlags),
				"avatarStoreSubcategoryFilteringFlags" => serde_json::from_value(value).map(Self::AvatarStoreSubcategoryFilteringFlags),
				"backgroundModeSettings" => serde_json::from_value(value).map(Self::BackgroundModeSettings),
				"battleAnimationSettings" => serde_json::from_value(value).map(Self::BattleAnimationSettings),
				"battleHubBadgeSettings" => serde_json::from_value(value).map(Self::BattleHubBadgeSettings),
				"battleHubOrderSettings" => serde_json::from_value(value).map(Self::BattleHubOrderSettings),
				"battleInputBufferSettings" => serde_json::from_value(value).map(Self::BattleInputBufferSettings),
				"battlePartySettings" => serde_json::from_value(value).map(Self::BattlePartySettings),
				"battleSettings" => serde_json::from_value(value).map(Self::BattleSettings),
				"battleVisualSettings" => serde_json::from_value(value).map(Self::BattleVisualSettings),
				"belugaPokemonWhitelist" => serde_json::from_value(value).map(Self::BelugaPokemonWhitelist),
				"bestFriendsPlusSettings" => serde_json::from_value(value).map(Self::BestFriendsPlusSettings),
				"breadBattleClientSettings" => serde_json::from_value(value).map(Self::BreadBattleClientSettings),
				"breadFeatureFlags" => serde_json::from_value(value).map(Self::BreadFeatureFlags),
				"breadLobbyCounterSettings" => serde_json::from_value(value).map(Self::BreadLobbyCounterSettings),
				"breadLobbyUpdateSettings" => serde_json::from_value(value).map(Self::BreadLobbyUpdateSettings),
				"breadMoveMappings" => serde_json::from_value(value).map(Self::BreadMoveMappings),
				"breadPokemonScalingSettings" => serde_json::from_value(value).map(Self::BreadPokemonScalingSettings),
				"breadSettings" => serde_json::from_value(value).map(Self::BreadSettings),
				"buddyEncounterCameoSettings" => serde_json::from_value(value).map(Self::BuddyEncounterCameoSettings),
				"buddyHungerSettings" => serde_json::from_value(value).map(Self::BuddyHungerSettings),
				"buddyInteractionSettings" => serde_json::from_value(value).map(Self::BuddyInteractionSettings),
				...
				"bulkHealingSettings" => serde_json::from_value(value).map(Self::BulkHealingSettings),
				"butterflyCollectorSettings" => serde_json::from_value(value).map(Self::ButterflyCollectorSettings),
				"campfireSettings" => serde_json::from_value(value).map(Self::CampfireSettings),
				"catchRadiusMultiplierSettings" => serde_json::from_value(value).map(Self::CatchRadiusMultiplierSettings),
				"combatCompetitiveSeasonSettings" => serde_json::from_value(value).map(Self::CombatCompetitiveSeasonSettings),
				"combatLeagueSettings" => serde_json::from_value(value).map(Self::CombatLeagueSettings),
				"combatSettings" => serde_json::from_value(value).map(Self::CombatSettings),
				"combatStatStageSettings" => serde_json::from_value(value).map(Self::CombatStatStageSettings),
				"contestSettings" => serde_json::from_value(value).map(Self::ContestSettings),
				"conversationSettings" => serde_json::from_value(value).map(Self::ConversationSettings),
				"crossGameSocialSettings" => serde_json::from_value(value).map(Self::CrossGameSocialSettings),
				"dailyAdventureIncenseSettings" => serde_json::from_value(value).map(Self::DailyAdventureIncenseSettings),
				"deepLinkingSettings" => serde_json::from_value(value).map(Self::DeepLinkingSettings),
				"eggHatchImprovementsSettings" => serde_json::from_value(value).map(Self::EggHatchImprovementsSettings),
				"encounterSettings" => serde_json::from_value(value).map(Self::EncounterSettings),
				"eventPlannerPopularNotificationSettings" => serde_json::from_value(value).map(Self::EventPlannerPopularNotificationSettings),
				"externalAddressableAssetsSettings" => serde_json::from_value(value).map(Self::ExternalAddressableAssetsSettings),
				"featureUnlockLevelSettings" => serde_json::from_value(value).map(Self::FeatureUnlockLevelSettings),
				"geotargetedQuestSettings" => serde_json::from_value(value).map(Self::GeotargetedQuestSettings),
				...
				"ibfcLightweightSettings" => serde_json::from_value(value).map(Self::IbfcLightweightSettings),
				"impressionTrackingSettings" => serde_json::from_value(value).map(Self::ImpressionTrackingSettings),
				"inAppSurveySettings" => serde_json::from_value(value).map(Self::InAppSurveySettings),
				"incidentPrioritySettings" => serde_json::from_value(value).map(Self::IncidentPrioritySettings),
				"incidentVisibilitySettings" => serde_json::from_value(value).map(Self::IncidentVisibilitySettings),
				...
				"irisSocialUxFunnelSettings" => serde_json::from_value(value).map(Self::IrisSocialUxFunnelSettings),
				"itemInventoryUpdateSettings" => serde_json::from_value(value).map(Self::ItemInventoryUpdateSettings),
				"joinRaidViaFriendListSettings" => serde_json::from_value(value).map(Self::JoinRaidViaFriendListSettings),
				"languageSelectorSettings" => serde_json::from_value(value).map(Self::LanguageSelectorSettings),
				"luckyPokemonSettings" => serde_json::from_value(value).map(Self::LuckyPokemonSettings),
				...
				"mapObjectsInteractionRangeSettings" => serde_json::from_value(value).map(Self::MapObjectsInteractionRangeSettings),
				...
				"naturalArtDayNightFeatureSettings" => serde_json::from_value(value).map(Self::NaturalArtDayNightFeatureSettings),
				"nearbyPokemonSettings" => serde_json::from_value(value).map(Self::NearbyPokemonSettings),
				"neutralAvatarSettings" => serde_json::from_value(value).map(Self::NeutralAvatarSettings),
				...
				"partyDarkLaunchSettings" => serde_json::from_value(value).map(Self::PartyDarkLaunchSettings),
				"partyIapBoostsSettings" => serde_json::from_value(value).map(Self::PartyIapBoostsSettings),
				"partyRecommendationSettings" => serde_json::from_value(value).map(Self::PartyRecommendationSettings),
				...
				"playerBonusSystemSettings" => serde_json::from_value(value).map(Self::PlayerBonusSystemSettings),
				"playerLevel" => serde_json::from_value(value).map(Self::PlayerLevel),
				"pokeballThrowPropertySettings" => serde_json::from_value(value).map(Self::PokeballThrowPropertySettings),
				"pokecoinPurchaseDisplayGmt" => serde_json::from_value(value).map(Self::PokecoinPurchaseDisplayGmt),
				"pokedexCategoriesSettings" => serde_json::from_value(value).map(Self::PokedexCategoriesSettings),
				"pokedexSizeStatsSystemSettings" => serde_json::from_value(value).map(Self::PokedexSizeStatsSystemSettings),
				"pokedexv2FeatureFlags" => serde_json::from_value(value).map(Self::Pokedexv2featureFlags),
				...
				"pokemonHomeSettings" => serde_json::from_value(value).map(Self::PokemonHomeSettings),
				"pokemonTagSettings" => serde_json::from_value(value).map(Self::PokemonTagSettings),
				"popupControlSettings" => serde_json::from_value(value).map(Self::PopupControlSettings),
				"postcardCollectionSettings" => serde_json::from_value(value).map(Self::PostcardCollectionSettings),
				"powerUpPokestopsSettings" => serde_json::from_value(value).map(Self::PowerUpPokestopsSettings),
				...
				"quickInviteSettings" => serde_json::from_value(value).map(Self::QuickInviteSettings),
				"raidLobbyCounterSettings" => serde_json::from_value(value).map(Self::RaidLobbyCounterSettings),
				...
				"remoteTradeSettings" => serde_json::from_value(value).map(Self::RemoteTradeSettings),
				"routeBadgeSettings" => serde_json::from_value(value).map(Self::RouteBadgeSettings),
				"routeCreationSettings" => serde_json::from_value(value).map(Self::RouteCreationSettings),
				"routeDiscoverySettings" => serde_json::from_value(value).map(Self::RouteDiscoverySettings),
				...
				"routesNearbyNotifSettings" => serde_json::from_value(value).map(Self::RoutesNearbyNotifSettings),
				"routesPartyPlayInteropSettings" => serde_json::from_value(value).map(Self::RoutesPartyPlayInteropSettings),
				"routeStampCategorySettings" => serde_json::from_value(value).map(Self::RouteStampCategorySettings),
				"sharedFusionSettings" => serde_json::from_value(value).map(Self::SharedFusionSettings),
				"sharedMoveSettings" => serde_json::from_value(value).map(Self::SharedMoveSettings),
				"sourdoughMoveMappingSettings" => serde_json::from_value(value).map(Self::SourdoughMoveMappingSettings),
				"specialEggSettings" => serde_json::from_value(value).map(Self::SpecialEggSettings),
				"sponsoredGeofenceGiftSettings" => serde_json::from_value(value).map(Self::SponsoredGeofenceGiftSettings),
				"squashSettings" => serde_json::from_value(value).map(Self::SquashSettings),
				"stampCollectionSettings" => serde_json::from_value(value).map(Self::StampCollectionSettings),
				"stationedPokemonTableSettings" => serde_json::from_value(value).map(Self::StationedPokemonTableSettings),
				"stickerCategorySettings" => serde_json::from_value(value).map(Self::StickerCategorySettings),
				"styleShopSettings" => serde_json::from_value(value).map(Self::StyleShopSettings),
				"ticketGiftingSettings" => serde_json::from_value(value).map(Self::TicketGiftingSettings),
				...
				"usernameSuggestionSettings" => serde_json::from_value(value).map(Self::UsernameSuggestionSettings),
				"verboseLogCombatSettings" => serde_json::from_value(value).map(Self::VerboseLogCombatSettings),
				"verboseLogRaidSettings" => serde_json::from_value(value).map(Self::VerboseLogRaidSettings),
				"vistaGeneralSettings" => serde_json::from_value(value).map(Self::VistaGeneralSettings),
				"vnextBattleConfig" => serde_json::from_value(value).map(Self::VnextBattleConfig),
				"vsSeekerClientSettings" => serde_json::from_value(value).map(Self::VsSeekerClientSettings),
				"vsSeekerScheduleSettings" => serde_json::from_value(value).map(Self::VsSeekerScheduleSettings),
				"weatherBonusSettings" => serde_json::from_value(value).map(Self::WeatherBonusSettings),
			...
			match template_id.as_deref() {
				Some("ITEM_CURRENCY_VALUES") => serde_json::from_value(value).map(Self::ItemCurrencyValues),
				Some("QUEST_DIALOGUE_INBOX_SETTINGS") => serde_json::from_value(value).map(Self::QuestDialogueInboxSettings),
				Some("RAID_ENTRY_COST_SETTINGS") => serde_json::from_value(value).map(Self::RaidEntryCostSettings),
				Some("SOFT_SFIDA_SETTINGS") => serde_json::from_value(value).map(Self::SoftSfidaSettings),
