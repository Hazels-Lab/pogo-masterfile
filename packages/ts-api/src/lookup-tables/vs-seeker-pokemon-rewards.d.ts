...
import type { VsSeekerPokemonRewardsFree, VsSeekerPokemonRewardsPremium } from "pogo-masterfile-types/entries";

export interface VsSeekerPokemonRewardsLookup {
	VS_SEEKER_POKEMON_REWARDS_FREE: VsSeekerPokemonRewardsFree;
	VS_SEEKER_POKEMON_REWARDS_PREMIUM: VsSeekerPokemonRewardsPremium;
}
