...
export interface PokemonHomeEnergyCostsLookup {
	...
	ENERGY_COSTS_POKEMON_CLASS_MYTHIC: PokemonHomeEnergyCostsMythic;
	ENERGY_COSTS_POKEMON_CLASS_NORMAL: PokemonHomeEnergyCostsNormal;
	ENERGY_COSTS_POKEMON_CLASS_ULTRA_BEAST: PokemonHomeEnergyCostsUltraBeast;
}
